...
// checks if the ManagementV1APISpecLintingRuleset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1APISpecLintingRuleset{}

// ManagementV1APISpecLintingRuleset Definition of APISpecLintingRuleset for version v1 in group management.    Resource representing an Amplify Central API Specification Linting Ruleset
type ManagementV1APISpecLintingRuleset struct {
	...
	Spec ManagementV1APISpecLintingRulesetSpec `json:"spec"`
...
type _ManagementV1APISpecLintingRuleset ManagementV1APISpecLintingRuleset
...
func NewManagementV1APISpecLintingRuleset(spec ManagementV1APISpecLintingRulesetSpec) *ManagementV1APISpecLintingRuleset {
	this := ManagementV1APISpecLintingRuleset{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1APISpecLintingRuleset) GetSpec() ManagementV1APISpecLintingRulesetSpec {
	if o == nil {
		var ret ManagementV1APISpecLintingRulesetSpec
		return ret
	}
...
func (o ManagementV1APISpecLintingRuleset) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1APISpecLintingRuleset) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1APISpecLintingRuleset) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1APISpecLintingRuleset := _ManagementV1APISpecLintingRuleset{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1APISpecLintingRuleset)

	if err != nil {
		return err
	}

	*o = ManagementV1APISpecLintingRuleset(varManagementV1APISpecLintingRuleset)

	return err
}

type NullableManagementV1APISpecLintingRuleset struct {
	value *ManagementV1APISpecLintingRuleset
	isSet bool
}

func (v NullableManagementV1APISpecLintingRuleset) Get() *ManagementV1APISpecLintingRuleset {
	return v.value
}

func (v *NullableManagementV1APISpecLintingRuleset) Set(val *ManagementV1APISpecLintingRuleset) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1APISpecLintingRuleset) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1APISpecLintingRuleset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1APISpecLintingRuleset(val *ManagementV1APISpecLintingRuleset) *NullableManagementV1APISpecLintingRuleset {
	return &NullableManagementV1APISpecLintingRuleset{value: val, isSet: true}
}

func (v NullableManagementV1APISpecLintingRuleset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1APISpecLintingRuleset) UnmarshalJSON(src []byte) error {
	v.isSet = true
