...
// checks if the DefinitionsV1alpha1AccessControlListSpecAccessLevelScope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefinitionsV1alpha1AccessControlListSpecAccessLevelScope{}

// DefinitionsV1alpha1AccessControlListSpecAccessLevelScope struct for DefinitionsV1alpha1AccessControlListSpecAccessLevelScope
type DefinitionsV1alpha1AccessControlListSpecAccessLevelScope struct {
...
func NewDefinitionsV1alpha1AccessControlListSpecAccessLevelScope() *DefinitionsV1alpha1AccessControlListSpecAccessLevelScope {
	this := DefinitionsV1alpha1AccessControlListSpecAccessLevelScope{}
	return &this
}
...
func (o DefinitionsV1alpha1AccessControlListSpecAccessLevelScope) MarshalJSON() ([]byte, error) {
...
func (o DefinitionsV1alpha1AccessControlListSpecAccessLevelScope) ToMap() (map[string]interface{}, error) {
...
type NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope struct {
	value *DefinitionsV1alpha1AccessControlListSpecAccessLevelScope
	isSet bool
}

func (v NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) Get() *DefinitionsV1alpha1AccessControlListSpecAccessLevelScope {
	return v.value
}

func (v *NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) Set(val *DefinitionsV1alpha1AccessControlListSpecAccessLevelScope) {
	v.value = val
	v.isSet = true
}

func (v NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) IsSet() bool {
	return v.isSet
}

func (v *NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope(val *DefinitionsV1alpha1AccessControlListSpecAccessLevelScope) *NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope {
	return &NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope{value: val, isSet: true}
}

func (v NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefinitionsV1alpha1AccessControlListSpecAccessLevelScope) UnmarshalJSON(src []byte) error {
	v.isSet = true
