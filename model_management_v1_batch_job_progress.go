...
// checks if the ManagementV1BatchJobProgress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1BatchJobProgress{}

// ManagementV1BatchJobProgress struct for ManagementV1BatchJobProgress
type ManagementV1BatchJobProgress struct {
...
func NewManagementV1BatchJobProgress() *ManagementV1BatchJobProgress {
	this := ManagementV1BatchJobProgress{}
	return &this
}
...
func (o ManagementV1BatchJobProgress) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1BatchJobProgress) ToMap() (map[string]interface{}, error) {
...
type NullableManagementV1BatchJobProgress struct {
	value *ManagementV1BatchJobProgress
	isSet bool
}

func (v NullableManagementV1BatchJobProgress) Get() *ManagementV1BatchJobProgress {
	return v.value
}

func (v *NullableManagementV1BatchJobProgress) Set(val *ManagementV1BatchJobProgress) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1BatchJobProgress) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1BatchJobProgress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1BatchJobProgress(val *ManagementV1BatchJobProgress) *NullableManagementV1BatchJobProgress {
	return &NullableManagementV1BatchJobProgress{value: val, isSet: true}
}

func (v NullableManagementV1BatchJobProgress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1BatchJobProgress) UnmarshalJSON(src []byte) error {
	v.isSet = true
