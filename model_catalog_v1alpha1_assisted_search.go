...
// checks if the CatalogV1alpha1AssistedSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssistedSearch{}

// CatalogV1alpha1AssistedSearch Definition of AssistedSearch for version v1alpha1 in group catalog.    Resource representing a Marketplace Assisted Search settings
type CatalogV1alpha1AssistedSearch struct {
	...
	// Resource of kind AssistedSearch. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the AssistedSearch. AssistedSearch name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the AssistedSearch.
	...
	Spec CatalogV1alpha1AssistedSearchSpec `json:"spec"`
	State *CatalogV1alpha1AssistedSearchState `json:"state,omitempty"`
...
type _CatalogV1alpha1AssistedSearch CatalogV1alpha1AssistedSearch
...
func NewCatalogV1alpha1AssistedSearch(spec CatalogV1alpha1AssistedSearchSpec) *CatalogV1alpha1AssistedSearch {
	this := CatalogV1alpha1AssistedSearch{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1AssistedSearch) GetSpec() CatalogV1alpha1AssistedSearchSpec {
	if o == nil {
		var ret CatalogV1alpha1AssistedSearchSpec
		return ret
	}
...
func (o *CatalogV1alpha1AssistedSearch) GetState() CatalogV1alpha1AssistedSearchState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1AssistedSearchState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1AssistedSearchState and assigns it to the State field.
...
func (o CatalogV1alpha1AssistedSearch) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssistedSearch) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AssistedSearch) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AssistedSearch := _CatalogV1alpha1AssistedSearch{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AssistedSearch)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AssistedSearch(varCatalogV1alpha1AssistedSearch)

	return err
}

type NullableCatalogV1alpha1AssistedSearch struct {
	value *CatalogV1alpha1AssistedSearch
	isSet bool
}

func (v NullableCatalogV1alpha1AssistedSearch) Get() *CatalogV1alpha1AssistedSearch {
	return v.value
}

func (v *NullableCatalogV1alpha1AssistedSearch) Set(val *CatalogV1alpha1AssistedSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssistedSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssistedSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssistedSearch(val *CatalogV1alpha1AssistedSearch) *NullableCatalogV1alpha1AssistedSearch {
	return &NullableCatalogV1alpha1AssistedSearch{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssistedSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssistedSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true
