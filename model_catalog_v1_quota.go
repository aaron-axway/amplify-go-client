...
// checks if the CatalogV1Quota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1Quota{}

// CatalogV1Quota Definition of Quota for version v1 in group catalog.    Resource representing an Amplify Central Plan Quota.
type CatalogV1Quota struct {
	...
	Spec CatalogV1QuotaSpec `json:"spec"`
	Status *CatalogV1QuotaStatus `json:"status,omitempty"`
...
type _CatalogV1Quota CatalogV1Quota
...
// SetStatus gets a reference to the given CatalogV1QuotaStatus and assigns it to the Status field.
...
func (o CatalogV1Quota) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1Quota) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1Quota) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1Quota := _CatalogV1Quota{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1Quota)

	if err != nil {
		return err
	}

	*o = CatalogV1Quota(varCatalogV1Quota)

	return err
}

type NullableCatalogV1Quota struct {
	value *CatalogV1Quota
	isSet bool
}

func (v NullableCatalogV1Quota) Get() *CatalogV1Quota {
	return v.value
}

func (v *NullableCatalogV1Quota) Set(val *CatalogV1Quota) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1Quota) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1Quota) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1Quota(val *CatalogV1Quota) *NullableCatalogV1Quota {
	return &NullableCatalogV1Quota{value: val, isSet: true}
}

func (v NullableCatalogV1Quota) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1Quota) UnmarshalJSON(src []byte) error {
	v.isSet = true
