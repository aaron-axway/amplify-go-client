...
// checks if the CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource{}

// CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource struct for CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource
type CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource struct {
...
func NewCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource() *CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource {
	this := CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource{}
	return &this
}
...
func (o CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource struct {
	value *CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource
	isSet bool
}

func (v NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) Get() *CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource {
	return v.value
}

func (v *NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) Set(val *CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource(val *CatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) *NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource {
	return &NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssetMappingStatusOutputsInnerResourceAssetResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
