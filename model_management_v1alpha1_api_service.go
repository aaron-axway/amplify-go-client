...
// checks if the ManagementV1alpha1APIService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1APIService{}

// ManagementV1alpha1APIService Definition of APIService for version v1alpha1 in group management.    Resource representing an Amplify Central API Service
type ManagementV1alpha1APIService struct {
	...
	// Name of the APIService. APIService name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Status *ManagementV1alpha1APIServiceStatus `json:"status,omitempty"`
	Details *ManagementV1alpha1APIServiceDetails `json:"details,omitempty"`
	Compliance *ManagementV1alpha1APIServiceCompliance `json:"compliance,omitempty"`
	References *ManagementV1alpha1APIServiceReferences `json:"references,omitempty"`
	Source *ManagementV1alpha1APIServiceSource `json:"source,omitempty"`
...
type _ManagementV1alpha1APIService ManagementV1alpha1APIService
...
func NewManagementV1alpha1APIService(spec ManagementV1alpha1APIServiceSpec) *ManagementV1alpha1APIService {
	this := ManagementV1alpha1APIService{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1APIService) GetSpec() ManagementV1alpha1APIServiceSpec {
	if o == nil {
		var ret ManagementV1alpha1APIServiceSpec
		return ret
	}
...
func (o *ManagementV1alpha1APIService) GetStatus() ManagementV1alpha1APIServiceStatus {
	if o == nil || IsNil(o.Status) {
		var ret ManagementV1alpha1APIServiceStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ManagementV1alpha1APIServiceStatus and assigns it to the Status field.
...
func (o *ManagementV1alpha1APIService) GetDetails() ManagementV1alpha1APIServiceDetails {
	if o == nil || IsNil(o.Details) {
		var ret ManagementV1alpha1APIServiceDetails
		return ret
	}
	return *o.Details
}
...
// SetDetails gets a reference to the given ManagementV1alpha1APIServiceDetails and assigns it to the Details field.
...
func (o *ManagementV1alpha1APIService) GetCompliance() ManagementV1alpha1APIServiceCompliance {
	if o == nil || IsNil(o.Compliance) {
		var ret ManagementV1alpha1APIServiceCompliance
		return ret
	}
	return *o.Compliance
}
...
// SetCompliance gets a reference to the given ManagementV1alpha1APIServiceCompliance and assigns it to the Compliance field.
...
func (o *ManagementV1alpha1APIService) GetReferences() ManagementV1alpha1APIServiceReferences {
	if o == nil || IsNil(o.References) {
		var ret ManagementV1alpha1APIServiceReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given ManagementV1alpha1APIServiceReferences and assigns it to the References field.
...
func (o *ManagementV1alpha1APIService) GetSource() ManagementV1alpha1APIServiceSource {
	if o == nil || IsNil(o.Source) {
		var ret ManagementV1alpha1APIServiceSource
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given ManagementV1alpha1APIServiceSource and assigns it to the Source field.
...
func (o ManagementV1alpha1APIService) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1APIService) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1APIService) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1APIService := _ManagementV1alpha1APIService{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1APIService)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1APIService(varManagementV1alpha1APIService)

	return err
}

type NullableManagementV1alpha1APIService struct {
	value *ManagementV1alpha1APIService
	isSet bool
}

func (v NullableManagementV1alpha1APIService) Get() *ManagementV1alpha1APIService {
	return v.value
}

func (v *NullableManagementV1alpha1APIService) Set(val *ManagementV1alpha1APIService) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1APIService) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1APIService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1APIService(val *ManagementV1alpha1APIService) *NullableManagementV1alpha1APIService {
	return &NullableManagementV1alpha1APIService{value: val, isSet: true}
}

func (v NullableManagementV1alpha1APIService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1APIService) UnmarshalJSON(src []byte) error {
	v.isSet = true
