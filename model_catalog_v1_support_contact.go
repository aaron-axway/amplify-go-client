...
// checks if the CatalogV1SupportContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1SupportContact{}

// CatalogV1SupportContact Definition of SupportContact for version v1 in group catalog.    Resource representing a Support Contact information.
type CatalogV1SupportContact struct {
	...
	// Resource of kind SupportContact. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the SupportContact. SupportContact name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the SupportContact.
	...
	Spec CatalogV1SupportContactSpec `json:"spec"`
...
type _CatalogV1SupportContact CatalogV1SupportContact
...
func (o *CatalogV1SupportContact) GetSpec() CatalogV1SupportContactSpec {
	if o == nil {
		var ret CatalogV1SupportContactSpec
		return ret
	}
...
func (o CatalogV1SupportContact) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1SupportContact) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1SupportContact) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1SupportContact := _CatalogV1SupportContact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1SupportContact)

	if err != nil {
		return err
	}

	*o = CatalogV1SupportContact(varCatalogV1SupportContact)

	return err
}

type NullableCatalogV1SupportContact struct {
	value *CatalogV1SupportContact
	isSet bool
}

func (v NullableCatalogV1SupportContact) Get() *CatalogV1SupportContact {
	return v.value
}

func (v *NullableCatalogV1SupportContact) Set(val *CatalogV1SupportContact) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1SupportContact) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1SupportContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1SupportContact(val *CatalogV1SupportContact) *NullableCatalogV1SupportContact {
	return &NullableCatalogV1SupportContact{value: val, isSet: true}
}

func (v NullableCatalogV1SupportContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1SupportContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
