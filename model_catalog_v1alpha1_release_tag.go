...
// checks if the CatalogV1alpha1ReleaseTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ReleaseTag{}

// CatalogV1alpha1ReleaseTag Definition of ReleaseTag for version v1alpha1 in group catalog.    Resource representing an Amplify Central Release Tag
type CatalogV1alpha1ReleaseTag struct {
	...
	// Resource of kind ReleaseTag. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ReleaseTag. ReleaseTag name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ReleaseTag.
	...
	Spec CatalogV1alpha1ReleaseTagSpec `json:"spec"`
	State *string `json:"state,omitempty"`
	Status *CatalogV1alpha1ReleaseTagStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1ReleaseTag CatalogV1alpha1ReleaseTag
...
func NewCatalogV1alpha1ReleaseTag(spec CatalogV1alpha1ReleaseTagSpec) *CatalogV1alpha1ReleaseTag {
	this := CatalogV1alpha1ReleaseTag{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ReleaseTag) GetSpec() CatalogV1alpha1ReleaseTagSpec {
	if o == nil {
		var ret CatalogV1alpha1ReleaseTagSpec
		return ret
	}
...
func (o *CatalogV1alpha1ReleaseTag) GetStatus() CatalogV1alpha1ReleaseTagStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1ReleaseTagStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1ReleaseTagStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1ReleaseTag) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ReleaseTag) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ReleaseTag) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ReleaseTag := _CatalogV1alpha1ReleaseTag{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ReleaseTag)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ReleaseTag(varCatalogV1alpha1ReleaseTag)

	return err
}

type NullableCatalogV1alpha1ReleaseTag struct {
	value *CatalogV1alpha1ReleaseTag
	isSet bool
}

func (v NullableCatalogV1alpha1ReleaseTag) Get() *CatalogV1alpha1ReleaseTag {
	return v.value
}

func (v *NullableCatalogV1alpha1ReleaseTag) Set(val *CatalogV1alpha1ReleaseTag) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ReleaseTag) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ReleaseTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ReleaseTag(val *CatalogV1alpha1ReleaseTag) *NullableCatalogV1alpha1ReleaseTag {
	return &NullableCatalogV1alpha1ReleaseTag{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ReleaseTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ReleaseTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
