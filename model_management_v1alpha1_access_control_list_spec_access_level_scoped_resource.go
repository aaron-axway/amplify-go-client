...
// checks if the ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource{}

// ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource struct for ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource
type ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource struct {
...
type _ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource
...
func NewManagementV1alpha1AccessControlListSpecAccessLevelScopedResource(kind string, name string) *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource {
	this := ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1AccessControlListSpecAccessLevelScopedResource := _ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1AccessControlListSpecAccessLevelScopedResource)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource(varManagementV1alpha1AccessControlListSpecAccessLevelScopedResource)

	return err
}

type NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource struct {
	value *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource
	isSet bool
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) Get() *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource {
	return v.value
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) Set(val *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource(val *ManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource {
	return &NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
