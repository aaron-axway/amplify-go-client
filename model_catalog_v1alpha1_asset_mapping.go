...
// checks if the CatalogV1alpha1AssetMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssetMapping{}

// CatalogV1alpha1AssetMapping Definition of AssetMapping for version v1alpha1 in group catalog.    An AssetMapping based on the template or manually created.
type CatalogV1alpha1AssetMapping struct {
	...
	Spec CatalogV1alpha1AssetMappingSpec `json:"spec"`
	Status *CatalogV1alpha1AssetMappingStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1AssetMapping CatalogV1alpha1AssetMapping
...
func NewCatalogV1alpha1AssetMapping(spec CatalogV1alpha1AssetMappingSpec) *CatalogV1alpha1AssetMapping {
	this := CatalogV1alpha1AssetMapping{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1AssetMapping) GetSpec() CatalogV1alpha1AssetMappingSpec {
	if o == nil {
		var ret CatalogV1alpha1AssetMappingSpec
		return ret
	}
...
func (o *CatalogV1alpha1AssetMapping) GetStatus() CatalogV1alpha1AssetMappingStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1AssetMappingStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1AssetMappingStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1AssetMapping) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssetMapping) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AssetMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AssetMapping := _CatalogV1alpha1AssetMapping{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AssetMapping)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AssetMapping(varCatalogV1alpha1AssetMapping)

	return err
}

type NullableCatalogV1alpha1AssetMapping struct {
	value *CatalogV1alpha1AssetMapping
	isSet bool
}

func (v NullableCatalogV1alpha1AssetMapping) Get() *CatalogV1alpha1AssetMapping {
	return v.value
}

func (v *NullableCatalogV1alpha1AssetMapping) Set(val *CatalogV1alpha1AssetMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssetMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssetMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssetMapping(val *CatalogV1alpha1AssetMapping) *NullableCatalogV1alpha1AssetMapping {
	return &NullableCatalogV1alpha1AssetMapping{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssetMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssetMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
