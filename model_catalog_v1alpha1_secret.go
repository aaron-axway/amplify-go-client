...
// checks if the CatalogV1alpha1Secret type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Secret{}

// CatalogV1alpha1Secret Definition of Secret for version v1alpha1 in group catalog.    Secrets definitions.
type CatalogV1alpha1Secret struct {
	...
	// Name of the Secret. Secret name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1alpha1SecretSpec `json:"spec"`
...
type _CatalogV1alpha1Secret CatalogV1alpha1Secret
...
func (o *CatalogV1alpha1Secret) GetSpec() CatalogV1alpha1SecretSpec {
	if o == nil {
		var ret CatalogV1alpha1SecretSpec
		return ret
	}
...
func (o CatalogV1alpha1Secret) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Secret) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Secret) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Secret := _CatalogV1alpha1Secret{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Secret)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Secret(varCatalogV1alpha1Secret)

	return err
}

type NullableCatalogV1alpha1Secret struct {
	value *CatalogV1alpha1Secret
	isSet bool
}

func (v NullableCatalogV1alpha1Secret) Get() *CatalogV1alpha1Secret {
	return v.value
}

func (v *NullableCatalogV1alpha1Secret) Set(val *CatalogV1alpha1Secret) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Secret) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Secret) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Secret(val *CatalogV1alpha1Secret) *NullableCatalogV1alpha1Secret {
	return &NullableCatalogV1alpha1Secret{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Secret) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Secret) UnmarshalJSON(src []byte) error {
	v.isSet = true
