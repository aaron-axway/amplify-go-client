...
// checks if the ManagementV1alpha1APISpecLintingJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1APISpecLintingJob{}

// ManagementV1alpha1APISpecLintingJob Definition of APISpecLintingJob for version v1alpha1 in group management.    Resource representing an Amplify Central API Specification Linting Job
type ManagementV1alpha1APISpecLintingJob struct {
	...
	Spec ManagementV1alpha1APISpecLintingJobSpec `json:"spec"`
	Result *ManagementV1alpha1APISpecLintingJobResult `json:"result,omitempty"`
	// Set true if this lint job and its result has been archived.
	Archived *bool `json:"archived,omitempty"`
	State *ManagementV1alpha1APISpecLintingJobState `json:"state,omitempty"`
...
type _ManagementV1alpha1APISpecLintingJob ManagementV1alpha1APISpecLintingJob
...
func NewManagementV1alpha1APISpecLintingJob(spec ManagementV1alpha1APISpecLintingJobSpec) *ManagementV1alpha1APISpecLintingJob {
	this := ManagementV1alpha1APISpecLintingJob{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1APISpecLintingJob) GetSpec() ManagementV1alpha1APISpecLintingJobSpec {
	if o == nil {
		var ret ManagementV1alpha1APISpecLintingJobSpec
		return ret
	}
...
func (o *ManagementV1alpha1APISpecLintingJob) GetResult() ManagementV1alpha1APISpecLintingJobResult {
	if o == nil || IsNil(o.Result) {
		var ret ManagementV1alpha1APISpecLintingJobResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ManagementV1alpha1APISpecLintingJobResult and assigns it to the Result field.
...
func (o *ManagementV1alpha1APISpecLintingJob) GetState() ManagementV1alpha1APISpecLintingJobState {
	if o == nil || IsNil(o.State) {
		var ret ManagementV1alpha1APISpecLintingJobState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given ManagementV1alpha1APISpecLintingJobState and assigns it to the State field.
...
func (o ManagementV1alpha1APISpecLintingJob) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1APISpecLintingJob) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1APISpecLintingJob) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1APISpecLintingJob := _ManagementV1alpha1APISpecLintingJob{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1APISpecLintingJob)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1APISpecLintingJob(varManagementV1alpha1APISpecLintingJob)

	return err
}

type NullableManagementV1alpha1APISpecLintingJob struct {
	value *ManagementV1alpha1APISpecLintingJob
	isSet bool
}

func (v NullableManagementV1alpha1APISpecLintingJob) Get() *ManagementV1alpha1APISpecLintingJob {
	return v.value
}

func (v *NullableManagementV1alpha1APISpecLintingJob) Set(val *ManagementV1alpha1APISpecLintingJob) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1APISpecLintingJob) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1APISpecLintingJob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1APISpecLintingJob(val *ManagementV1alpha1APISpecLintingJob) *NullableManagementV1alpha1APISpecLintingJob {
	return &NullableManagementV1alpha1APISpecLintingJob{value: val, isSet: true}
}

func (v NullableManagementV1alpha1APISpecLintingJob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1APISpecLintingJob) UnmarshalJSON(src []byte) error {
	v.isSet = true
