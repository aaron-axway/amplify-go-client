...
// checks if the CatalogV1alpha1Product type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Product{}

// CatalogV1alpha1Product Definition of Product for version v1alpha1 in group catalog.    Resource representing an Amplify Central Product in the Products Catalog.
type CatalogV1alpha1Product struct {
	...
	Spec CatalogV1alpha1ProductSpec `json:"spec"`
	References *CatalogV1alpha1ProductReferences `json:"references,omitempty"`
	...
	Latestrelease *CatalogV1alpha1ProductLatestrelease `json:"latestrelease,omitempty"`
	State *CatalogV1alpha1ProductState `json:"state,omitempty"`
	Status *CatalogV1alpha1ProductStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1Product CatalogV1alpha1Product
...
func (o *CatalogV1alpha1Product) GetSpec() CatalogV1alpha1ProductSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductSpec
		return ret
	}
...
func (o *CatalogV1alpha1Product) GetReferences() CatalogV1alpha1ProductReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1alpha1ProductReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1alpha1ProductReferences and assigns it to the References field.
...
func (o *CatalogV1alpha1Product) GetLatestrelease() CatalogV1alpha1ProductLatestrelease {
	if o == nil || IsNil(o.Latestrelease) {
		var ret CatalogV1alpha1ProductLatestrelease
		return ret
	}
...
// SetLatestrelease gets a reference to the given CatalogV1alpha1ProductLatestrelease and assigns it to the Latestrelease field.
...
func (o *CatalogV1alpha1Product) GetState() CatalogV1alpha1ProductState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1ProductState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1ProductState and assigns it to the State field.
...
func (o *CatalogV1alpha1Product) GetStatus() CatalogV1alpha1ProductStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1ProductStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1ProductStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1Product) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Product) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Product) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Product := _CatalogV1alpha1Product{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Product)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Product(varCatalogV1alpha1Product)

	return err
}

type NullableCatalogV1alpha1Product struct {
	value *CatalogV1alpha1Product
	isSet bool
}

func (v NullableCatalogV1alpha1Product) Get() *CatalogV1alpha1Product {
	return v.value
}

func (v *NullableCatalogV1alpha1Product) Set(val *CatalogV1alpha1Product) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Product) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Product) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Product(val *CatalogV1alpha1Product) *NullableCatalogV1alpha1Product {
	return &NullableCatalogV1alpha1Product{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Product) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Product) UnmarshalJSON(src []byte) error {
	v.isSet = true
