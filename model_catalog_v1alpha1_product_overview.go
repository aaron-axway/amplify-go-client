...
// checks if the CatalogV1alpha1ProductOverview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductOverview{}

// CatalogV1alpha1ProductOverview Definition of ProductOverview for version v1alpha1 in group catalog.    Resource that defines the properties of the Product overview for Marketplace
type CatalogV1alpha1ProductOverview struct {
	...
	// Resource of kind ProductOverview. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductOverview. ProductOverview name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductOverview.
	...
	Spec CatalogV1alpha1ProductOverviewSpec `json:"spec"`
...
type _CatalogV1alpha1ProductOverview CatalogV1alpha1ProductOverview
...
func NewCatalogV1alpha1ProductOverview(spec CatalogV1alpha1ProductOverviewSpec) *CatalogV1alpha1ProductOverview {
	this := CatalogV1alpha1ProductOverview{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductOverview) GetSpec() CatalogV1alpha1ProductOverviewSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductOverviewSpec
		return ret
	}
...
func (o CatalogV1alpha1ProductOverview) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductOverview) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductOverview) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductOverview := _CatalogV1alpha1ProductOverview{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductOverview)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductOverview(varCatalogV1alpha1ProductOverview)

	return err
}

type NullableCatalogV1alpha1ProductOverview struct {
	value *CatalogV1alpha1ProductOverview
	isSet bool
}

func (v NullableCatalogV1alpha1ProductOverview) Get() *CatalogV1alpha1ProductOverview {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductOverview) Set(val *CatalogV1alpha1ProductOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductOverview(val *CatalogV1alpha1ProductOverview) *NullableCatalogV1alpha1ProductOverview {
	return &NullableCatalogV1alpha1ProductOverview{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
