...
// checks if the CatalogV1alpha1SubscriptionInvoice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1SubscriptionInvoice{}

// CatalogV1alpha1SubscriptionInvoice Definition of SubscriptionInvoice for version v1alpha1 in group catalog.    Resource representing a Subscription invoice.
type CatalogV1alpha1SubscriptionInvoice struct {
	...
	// Resource of kind SubscriptionInvoice. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the SubscriptionInvoice. SubscriptionInvoice name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the SubscriptionInvoice.
	...
	Spec CatalogV1alpha1SubscriptionInvoiceSpec `json:"spec"`
	Marketplace *CatalogV1alpha1SubscriptionInvoiceMarketplace `json:"marketplace,omitempty"`
	State *CatalogV1alpha1SubscriptionInvoiceState `json:"state,omitempty"`
	Billing *CatalogV1alpha1SubscriptionInvoiceBilling `json:"billing,omitempty"`
	Status *CatalogV1alpha1SubscriptionInvoiceStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1SubscriptionInvoice CatalogV1alpha1SubscriptionInvoice
...
func NewCatalogV1alpha1SubscriptionInvoice(spec CatalogV1alpha1SubscriptionInvoiceSpec) *CatalogV1alpha1SubscriptionInvoice {
	this := CatalogV1alpha1SubscriptionInvoice{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1SubscriptionInvoice) GetSpec() CatalogV1alpha1SubscriptionInvoiceSpec {
	if o == nil {
		var ret CatalogV1alpha1SubscriptionInvoiceSpec
		return ret
	}
...
func (o *CatalogV1alpha1SubscriptionInvoice) GetMarketplace() CatalogV1alpha1SubscriptionInvoiceMarketplace {
	if o == nil || IsNil(o.Marketplace) {
		var ret CatalogV1alpha1SubscriptionInvoiceMarketplace
		return ret
	}
...
// SetMarketplace gets a reference to the given CatalogV1alpha1SubscriptionInvoiceMarketplace and assigns it to the Marketplace field.
...
func (o *CatalogV1alpha1SubscriptionInvoice) GetState() CatalogV1alpha1SubscriptionInvoiceState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1SubscriptionInvoiceState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1SubscriptionInvoiceState and assigns it to the State field.
...
func (o *CatalogV1alpha1SubscriptionInvoice) GetBilling() CatalogV1alpha1SubscriptionInvoiceBilling {
	if o == nil || IsNil(o.Billing) {
		var ret CatalogV1alpha1SubscriptionInvoiceBilling
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given CatalogV1alpha1SubscriptionInvoiceBilling and assigns it to the Billing field.
...
func (o *CatalogV1alpha1SubscriptionInvoice) GetStatus() CatalogV1alpha1SubscriptionInvoiceStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1SubscriptionInvoiceStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1SubscriptionInvoiceStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1SubscriptionInvoice) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1SubscriptionInvoice) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1SubscriptionInvoice) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1SubscriptionInvoice := _CatalogV1alpha1SubscriptionInvoice{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1SubscriptionInvoice)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1SubscriptionInvoice(varCatalogV1alpha1SubscriptionInvoice)

	return err
}

type NullableCatalogV1alpha1SubscriptionInvoice struct {
	value *CatalogV1alpha1SubscriptionInvoice
	isSet bool
}

func (v NullableCatalogV1alpha1SubscriptionInvoice) Get() *CatalogV1alpha1SubscriptionInvoice {
	return v.value
}

func (v *NullableCatalogV1alpha1SubscriptionInvoice) Set(val *CatalogV1alpha1SubscriptionInvoice) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1SubscriptionInvoice) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1SubscriptionInvoice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1SubscriptionInvoice(val *CatalogV1alpha1SubscriptionInvoice) *NullableCatalogV1alpha1SubscriptionInvoice {
	return &NullableCatalogV1alpha1SubscriptionInvoice{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1SubscriptionInvoice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1SubscriptionInvoice) UnmarshalJSON(src []byte) error {
	v.isSet = true
