...
// checks if the CatalogV1alpha1Category type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Category{}

// CatalogV1alpha1Category Definition of Category for version v1alpha1 in group catalog.    Resource representing a category
type CatalogV1alpha1Category struct {
	...
	Spec CatalogV1alpha1CategorySpec `json:"spec"`
...
type _CatalogV1alpha1Category CatalogV1alpha1Category
...
func (o *CatalogV1alpha1Category) GetSpec() CatalogV1alpha1CategorySpec {
	if o == nil {
		var ret CatalogV1alpha1CategorySpec
		return ret
	}
...
func (o CatalogV1alpha1Category) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Category) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Category) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Category := _CatalogV1alpha1Category{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Category)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Category(varCatalogV1alpha1Category)

	return err
}

type NullableCatalogV1alpha1Category struct {
	value *CatalogV1alpha1Category
	isSet bool
}

func (v NullableCatalogV1alpha1Category) Get() *CatalogV1alpha1Category {
	return v.value
}

func (v *NullableCatalogV1alpha1Category) Set(val *CatalogV1alpha1Category) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Category) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Category) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Category(val *CatalogV1alpha1Category) *NullableCatalogV1alpha1Category {
	return &NullableCatalogV1alpha1Category{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Category) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Category) UnmarshalJSON(src []byte) error {
	v.isSet = true
