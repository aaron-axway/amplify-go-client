...
// checks if the ManagementV1alpha1Mesh type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1Mesh{}

// ManagementV1alpha1Mesh Definition of Mesh for version v1alpha1 in group management.    Resource representing a Mesh.
type ManagementV1alpha1Mesh struct {
	...
	// Resource of kind Mesh. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Mesh. Mesh name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
...
type _ManagementV1alpha1Mesh ManagementV1alpha1Mesh
...
func (o ManagementV1alpha1Mesh) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1Mesh) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1Mesh) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1Mesh := _ManagementV1alpha1Mesh{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1Mesh)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1Mesh(varManagementV1alpha1Mesh)

	return err
}

type NullableManagementV1alpha1Mesh struct {
	value *ManagementV1alpha1Mesh
	isSet bool
}

func (v NullableManagementV1alpha1Mesh) Get() *ManagementV1alpha1Mesh {
	return v.value
}

func (v *NullableManagementV1alpha1Mesh) Set(val *ManagementV1alpha1Mesh) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1Mesh) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1Mesh) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1Mesh(val *ManagementV1alpha1Mesh) *NullableManagementV1alpha1Mesh {
	return &NullableManagementV1alpha1Mesh{value: val, isSet: true}
}

func (v NullableManagementV1alpha1Mesh) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1Mesh) UnmarshalJSON(src []byte) error {
	v.isSet = true
