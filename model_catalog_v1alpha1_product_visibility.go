...
// checks if the CatalogV1alpha1ProductVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductVisibility{}

// CatalogV1alpha1ProductVisibility Definition of ProductVisibility for version v1alpha1 in group catalog.    Resource representing Products visibility settings in the Marketplace
type CatalogV1alpha1ProductVisibility struct {
	...
	// Resource of kind ProductVisibility. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductVisibility. ProductVisibility name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductVisibility.
	...
	Spec CatalogV1alpha1ProductVisibilitySpec `json:"spec"`
...
type _CatalogV1alpha1ProductVisibility CatalogV1alpha1ProductVisibility
...
func NewCatalogV1alpha1ProductVisibility(spec CatalogV1alpha1ProductVisibilitySpec) *CatalogV1alpha1ProductVisibility {
	this := CatalogV1alpha1ProductVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductVisibility) GetSpec() CatalogV1alpha1ProductVisibilitySpec {
	if o == nil {
		var ret CatalogV1alpha1ProductVisibilitySpec
		return ret
	}
...
func (o CatalogV1alpha1ProductVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductVisibility := _CatalogV1alpha1ProductVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductVisibility(varCatalogV1alpha1ProductVisibility)

	return err
}

type NullableCatalogV1alpha1ProductVisibility struct {
	value *CatalogV1alpha1ProductVisibility
	isSet bool
}

func (v NullableCatalogV1alpha1ProductVisibility) Get() *CatalogV1alpha1ProductVisibility {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductVisibility) Set(val *CatalogV1alpha1ProductVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductVisibility(val *CatalogV1alpha1ProductVisibility) *NullableCatalogV1alpha1ProductVisibility {
	return &NullableCatalogV1alpha1ProductVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
