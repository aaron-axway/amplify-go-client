...
// checks if the CatalogV1alpha1SupportContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1SupportContact{}

// CatalogV1alpha1SupportContact Definition of SupportContact for version v1alpha1 in group catalog.    Resource representing a Support Contact information.
type CatalogV1alpha1SupportContact struct {
	...
	Spec CatalogV1alpha1SupportContactSpec `json:"spec"`
...
type _CatalogV1alpha1SupportContact CatalogV1alpha1SupportContact
...
func NewCatalogV1alpha1SupportContact(spec CatalogV1alpha1SupportContactSpec) *CatalogV1alpha1SupportContact {
	this := CatalogV1alpha1SupportContact{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1SupportContact) GetSpec() CatalogV1alpha1SupportContactSpec {
	if o == nil {
		var ret CatalogV1alpha1SupportContactSpec
		return ret
	}
...
func (o CatalogV1alpha1SupportContact) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1SupportContact) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1SupportContact) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1SupportContact := _CatalogV1alpha1SupportContact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1SupportContact)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1SupportContact(varCatalogV1alpha1SupportContact)

	return err
}

type NullableCatalogV1alpha1SupportContact struct {
	value *CatalogV1alpha1SupportContact
	isSet bool
}

func (v NullableCatalogV1alpha1SupportContact) Get() *CatalogV1alpha1SupportContact {
	return v.value
}

func (v *NullableCatalogV1alpha1SupportContact) Set(val *CatalogV1alpha1SupportContact) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1SupportContact) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1SupportContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1SupportContact(val *CatalogV1alpha1SupportContact) *NullableCatalogV1alpha1SupportContact {
	return &NullableCatalogV1alpha1SupportContact{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1SupportContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1SupportContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
