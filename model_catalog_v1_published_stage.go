...
// checks if the CatalogV1PublishedStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1PublishedStage{}

// CatalogV1PublishedStage Definition of PublishedStage for version v1 in group catalog.    Resource representing a Published Stage into a Marketplace
type CatalogV1PublishedStage struct {
	...
	Spec CatalogV1PublishedStageSpec `json:"spec"`
...
type _CatalogV1PublishedStage CatalogV1PublishedStage
...
func (o *CatalogV1PublishedStage) GetSpec() CatalogV1PublishedStageSpec {
	if o == nil {
		var ret CatalogV1PublishedStageSpec
		return ret
	}
...
func (o CatalogV1PublishedStage) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1PublishedStage) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1PublishedStage) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1PublishedStage := _CatalogV1PublishedStage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1PublishedStage)

	if err != nil {
		return err
	}

	*o = CatalogV1PublishedStage(varCatalogV1PublishedStage)

	return err
}

type NullableCatalogV1PublishedStage struct {
	value *CatalogV1PublishedStage
	isSet bool
}

func (v NullableCatalogV1PublishedStage) Get() *CatalogV1PublishedStage {
	return v.value
}

func (v *NullableCatalogV1PublishedStage) Set(val *CatalogV1PublishedStage) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1PublishedStage) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1PublishedStage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1PublishedStage(val *CatalogV1PublishedStage) *NullableCatalogV1PublishedStage {
	return &NullableCatalogV1PublishedStage{value: val, isSet: true}
}

func (v NullableCatalogV1PublishedStage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1PublishedStage) UnmarshalJSON(src []byte) error {
	v.isSet = true
