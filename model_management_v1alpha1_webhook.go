...
// checks if the ManagementV1alpha1Webhook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1Webhook{}

// ManagementV1alpha1Webhook Definition of Webhook for version v1alpha1 in group management.    Resource representing Webhook Configuration
...
type _ManagementV1alpha1Webhook ManagementV1alpha1Webhook
...
func NewManagementV1alpha1Webhook(spec ManagementV1alpha1WebhookSpec) *ManagementV1alpha1Webhook {
	this := ManagementV1alpha1Webhook{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1Webhook) GetSpec() ManagementV1alpha1WebhookSpec {
	if o == nil {
		var ret ManagementV1alpha1WebhookSpec
		return ret
	}
...
func (o ManagementV1alpha1Webhook) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1Webhook) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1Webhook) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1Webhook := _ManagementV1alpha1Webhook{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1Webhook)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1Webhook(varManagementV1alpha1Webhook)

	return err
}

type NullableManagementV1alpha1Webhook struct {
	value *ManagementV1alpha1Webhook
	isSet bool
}

func (v NullableManagementV1alpha1Webhook) Get() *ManagementV1alpha1Webhook {
	return v.value
}

func (v *NullableManagementV1alpha1Webhook) Set(val *ManagementV1alpha1Webhook) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1Webhook) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1Webhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1Webhook(val *ManagementV1alpha1Webhook) *NullableManagementV1alpha1Webhook {
	return &NullableManagementV1alpha1Webhook{value: val, isSet: true}
}

func (v NullableManagementV1alpha1Webhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1Webhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
