...
// checks if the ManagementV1alpha1APIServiceRevision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1APIServiceRevision{}

// ManagementV1alpha1APIServiceRevision Definition of APIServiceRevision for version v1alpha1 in group management.    Resource representing an Amplify Central API Service Revision
type ManagementV1alpha1APIServiceRevision struct {
	...
	// Name of the APIServiceRevision. APIServiceRevision name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Compliance *ManagementV1alpha1APIServiceRevisionCompliance `json:"compliance,omitempty"`
...
type _ManagementV1alpha1APIServiceRevision ManagementV1alpha1APIServiceRevision
...
func NewManagementV1alpha1APIServiceRevision(spec ManagementV1alpha1APIServiceRevisionSpec) *ManagementV1alpha1APIServiceRevision {
	this := ManagementV1alpha1APIServiceRevision{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1APIServiceRevision) GetSpec() ManagementV1alpha1APIServiceRevisionSpec {
	if o == nil {
		var ret ManagementV1alpha1APIServiceRevisionSpec
		return ret
	}
...
func (o *ManagementV1alpha1APIServiceRevision) GetCompliance() ManagementV1alpha1APIServiceRevisionCompliance {
	if o == nil || IsNil(o.Compliance) {
		var ret ManagementV1alpha1APIServiceRevisionCompliance
		return ret
	}
	return *o.Compliance
}
...
// SetCompliance gets a reference to the given ManagementV1alpha1APIServiceRevisionCompliance and assigns it to the Compliance field.
...
func (o ManagementV1alpha1APIServiceRevision) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1APIServiceRevision) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1APIServiceRevision) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1APIServiceRevision := _ManagementV1alpha1APIServiceRevision{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1APIServiceRevision)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1APIServiceRevision(varManagementV1alpha1APIServiceRevision)

	return err
}

type NullableManagementV1alpha1APIServiceRevision struct {
	value *ManagementV1alpha1APIServiceRevision
	isSet bool
}

func (v NullableManagementV1alpha1APIServiceRevision) Get() *ManagementV1alpha1APIServiceRevision {
	return v.value
}

func (v *NullableManagementV1alpha1APIServiceRevision) Set(val *ManagementV1alpha1APIServiceRevision) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1APIServiceRevision) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1APIServiceRevision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1APIServiceRevision(val *ManagementV1alpha1APIServiceRevision) *NullableManagementV1alpha1APIServiceRevision {
	return &NullableManagementV1alpha1APIServiceRevision{value: val, isSet: true}
}

func (v NullableManagementV1alpha1APIServiceRevision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1APIServiceRevision) UnmarshalJSON(src []byte) error {
	v.isSet = true
