...
// checks if the CatalogV1alpha1AssetRequestDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssetRequestDefinition{}

// CatalogV1alpha1AssetRequestDefinition Definition of AssetRequestDefinition for version v1alpha1 in group catalog.    Resource representing requirements for accessing an AssetResource
type CatalogV1alpha1AssetRequestDefinition struct {
	...
	// Resource of kind AssetRequestDefinition. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the AssetRequestDefinition. AssetRequestDefinition name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the AssetRequestDefinition.
	...
	Spec CatalogV1alpha1AssetRequestDefinitionSpec `json:"spec"`
	Authorization *CatalogV1alpha1AssetRequestDefinitionAuthorization `json:"authorization,omitempty"`
...
type _CatalogV1alpha1AssetRequestDefinition CatalogV1alpha1AssetRequestDefinition
...
func NewCatalogV1alpha1AssetRequestDefinition(spec CatalogV1alpha1AssetRequestDefinitionSpec) *CatalogV1alpha1AssetRequestDefinition {
	this := CatalogV1alpha1AssetRequestDefinition{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1AssetRequestDefinition) GetSpec() CatalogV1alpha1AssetRequestDefinitionSpec {
	if o == nil {
		var ret CatalogV1alpha1AssetRequestDefinitionSpec
		return ret
	}
...
func (o *CatalogV1alpha1AssetRequestDefinition) GetAuthorization() CatalogV1alpha1AssetRequestDefinitionAuthorization {
	if o == nil || IsNil(o.Authorization) {
		var ret CatalogV1alpha1AssetRequestDefinitionAuthorization
		return ret
	}
...
// SetAuthorization gets a reference to the given CatalogV1alpha1AssetRequestDefinitionAuthorization and assigns it to the Authorization field.
...
func (o CatalogV1alpha1AssetRequestDefinition) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssetRequestDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AssetRequestDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AssetRequestDefinition := _CatalogV1alpha1AssetRequestDefinition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AssetRequestDefinition)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AssetRequestDefinition(varCatalogV1alpha1AssetRequestDefinition)

	return err
}

type NullableCatalogV1alpha1AssetRequestDefinition struct {
	value *CatalogV1alpha1AssetRequestDefinition
	isSet bool
}

func (v NullableCatalogV1alpha1AssetRequestDefinition) Get() *CatalogV1alpha1AssetRequestDefinition {
	return v.value
}

func (v *NullableCatalogV1alpha1AssetRequestDefinition) Set(val *CatalogV1alpha1AssetRequestDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssetRequestDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssetRequestDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssetRequestDefinition(val *CatalogV1alpha1AssetRequestDefinition) *NullableCatalogV1alpha1AssetRequestDefinition {
	return &NullableCatalogV1alpha1AssetRequestDefinition{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssetRequestDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssetRequestDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
