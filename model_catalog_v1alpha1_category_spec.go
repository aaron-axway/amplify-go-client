...
// checks if the CatalogV1alpha1CategorySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1CategorySpec{}

// CatalogV1alpha1CategorySpec struct for CatalogV1alpha1CategorySpec
type CatalogV1alpha1CategorySpec struct {
	...
	Restriction *CatalogV1alpha1CategorySpecRestriction `json:"restriction,omitempty"`
}
...
func NewCatalogV1alpha1CategorySpec() *CatalogV1alpha1CategorySpec {
	this := CatalogV1alpha1CategorySpec{}
	return &this
}
...
func (o *CatalogV1alpha1CategorySpec) GetRestriction() CatalogV1alpha1CategorySpecRestriction {
	if o == nil || IsNil(o.Restriction) {
		var ret CatalogV1alpha1CategorySpecRestriction
		return ret
	}
...
// SetRestriction gets a reference to the given CatalogV1alpha1CategorySpecRestriction and assigns it to the Restriction field.
func (o *CatalogV1alpha1CategorySpec) SetRestriction(v CatalogV1alpha1CategorySpecRestriction) {
	o.Restriction = &v
}

func (o CatalogV1alpha1CategorySpec) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1CategorySpec) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogV1alpha1CategorySpec struct {
	value *CatalogV1alpha1CategorySpec
	isSet bool
}

func (v NullableCatalogV1alpha1CategorySpec) Get() *CatalogV1alpha1CategorySpec {
	return v.value
}

func (v *NullableCatalogV1alpha1CategorySpec) Set(val *CatalogV1alpha1CategorySpec) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1CategorySpec) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1CategorySpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1CategorySpec(val *CatalogV1alpha1CategorySpec) *NullableCatalogV1alpha1CategorySpec {
	return &NullableCatalogV1alpha1CategorySpec{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1CategorySpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1CategorySpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
