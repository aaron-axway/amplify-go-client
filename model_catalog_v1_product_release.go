...
// checks if the CatalogV1ProductRelease type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1ProductRelease{}

// CatalogV1ProductRelease Definition of ProductRelease for version v1 in group catalog.    Resource representing a Product release.
type CatalogV1ProductRelease struct {
	...
	Spec CatalogV1ProductReleaseSpec `json:"spec"`
	References *CatalogV1ProductReleaseReferences `json:"references,omitempty"`
	...
	Status *CatalogV1ProductReleaseStatus `json:"status,omitempty"`
...
type _CatalogV1ProductRelease CatalogV1ProductRelease
...
func (o *CatalogV1ProductRelease) GetSpec() CatalogV1ProductReleaseSpec {
	if o == nil {
		var ret CatalogV1ProductReleaseSpec
		return ret
	}
...
func (o *CatalogV1ProductRelease) GetReferences() CatalogV1ProductReleaseReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1ProductReleaseReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1ProductReleaseReferences and assigns it to the References field.
...
func (o *CatalogV1ProductRelease) GetStatus() CatalogV1ProductReleaseStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1ProductReleaseStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1ProductReleaseStatus and assigns it to the Status field.
...
func (o CatalogV1ProductRelease) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1ProductRelease) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1ProductRelease) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1ProductRelease := _CatalogV1ProductRelease{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1ProductRelease)

	if err != nil {
		return err
	}

	*o = CatalogV1ProductRelease(varCatalogV1ProductRelease)

	return err
}

type NullableCatalogV1ProductRelease struct {
	value *CatalogV1ProductRelease
	isSet bool
}

func (v NullableCatalogV1ProductRelease) Get() *CatalogV1ProductRelease {
	return v.value
}

func (v *NullableCatalogV1ProductRelease) Set(val *CatalogV1ProductRelease) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1ProductRelease) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1ProductRelease) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1ProductRelease(val *CatalogV1ProductRelease) *NullableCatalogV1ProductRelease {
	return &NullableCatalogV1ProductRelease{value: val, isSet: true}
}

func (v NullableCatalogV1ProductRelease) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1ProductRelease) UnmarshalJSON(src []byte) error {
	v.isSet = true
