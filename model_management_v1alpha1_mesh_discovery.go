...
// checks if the ManagementV1alpha1MeshDiscovery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1MeshDiscovery{}

// ManagementV1alpha1MeshDiscovery Definition of MeshDiscovery for version v1alpha1 in group management.    A MeshDiscovery is used to promote services discovered in a mesh to the provider model.
type ManagementV1alpha1MeshDiscovery struct {
	...
	// Resource of kind MeshDiscovery. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the MeshDiscovery. MeshDiscovery name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the MeshDiscovery.
	...
	Spec ManagementV1alpha1MeshDiscoverySpec `json:"spec"`
...
type _ManagementV1alpha1MeshDiscovery ManagementV1alpha1MeshDiscovery
...
func NewManagementV1alpha1MeshDiscovery(spec ManagementV1alpha1MeshDiscoverySpec) *ManagementV1alpha1MeshDiscovery {
	this := ManagementV1alpha1MeshDiscovery{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1MeshDiscovery) GetSpec() ManagementV1alpha1MeshDiscoverySpec {
	if o == nil {
		var ret ManagementV1alpha1MeshDiscoverySpec
		return ret
	}
...
func (o ManagementV1alpha1MeshDiscovery) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1MeshDiscovery) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1MeshDiscovery) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1MeshDiscovery := _ManagementV1alpha1MeshDiscovery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1MeshDiscovery)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1MeshDiscovery(varManagementV1alpha1MeshDiscovery)

	return err
}

type NullableManagementV1alpha1MeshDiscovery struct {
	value *ManagementV1alpha1MeshDiscovery
	isSet bool
}

func (v NullableManagementV1alpha1MeshDiscovery) Get() *ManagementV1alpha1MeshDiscovery {
	return v.value
}

func (v *NullableManagementV1alpha1MeshDiscovery) Set(val *ManagementV1alpha1MeshDiscovery) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1MeshDiscovery) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1MeshDiscovery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1MeshDiscovery(val *ManagementV1alpha1MeshDiscovery) *NullableManagementV1alpha1MeshDiscovery {
	return &NullableManagementV1alpha1MeshDiscovery{value: val, isSet: true}
}

func (v NullableManagementV1alpha1MeshDiscovery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1MeshDiscovery) UnmarshalJSON(src []byte) error {
	v.isSet = true
