...
// checks if the CatalogV1Resource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1Resource{}

// CatalogV1Resource Definition of Resource for version v1 in group catalog.    Resource representing a Product resource
type CatalogV1Resource struct {
	...
	// Resource of kind Resource. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Resource. Resource name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1ResourceSpec `json:"spec"`
...
type _CatalogV1Resource CatalogV1Resource
...
func (o CatalogV1Resource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1Resource) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1Resource) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1Resource := _CatalogV1Resource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1Resource)

	if err != nil {
		return err
	}

	*o = CatalogV1Resource(varCatalogV1Resource)

	return err
}

type NullableCatalogV1Resource struct {
	value *CatalogV1Resource
	isSet bool
}

func (v NullableCatalogV1Resource) Get() *CatalogV1Resource {
	return v.value
}

func (v *NullableCatalogV1Resource) Set(val *CatalogV1Resource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1Resource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1Resource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1Resource(val *CatalogV1Resource) *NullableCatalogV1Resource {
	return &NullableCatalogV1Resource{value: val, isSet: true}
}

func (v NullableCatalogV1Resource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1Resource) UnmarshalJSON(src []byte) error {
	v.isSet = true
