...
// checks if the CatalogV1alpha1Application type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Application{}

// CatalogV1alpha1Application Definition of Application for version v1alpha1 in group catalog.    Defines group of applications.
type CatalogV1alpha1Application struct {
	...
	// Resource of kind Application. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Application. Application name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1alpha1ApplicationSpec `json:"spec"`
	Marketplace *CatalogV1alpha1ApplicationMarketplace `json:"marketplace,omitempty"`
	State *CatalogV1alpha1ApplicationState `json:"state,omitempty"`
...
type _CatalogV1alpha1Application CatalogV1alpha1Application
...
func NewCatalogV1alpha1Application(spec CatalogV1alpha1ApplicationSpec) *CatalogV1alpha1Application {
	this := CatalogV1alpha1Application{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1Application) GetSpec() CatalogV1alpha1ApplicationSpec {
	if o == nil {
		var ret CatalogV1alpha1ApplicationSpec
		return ret
	}
...
func (o *CatalogV1alpha1Application) GetMarketplace() CatalogV1alpha1ApplicationMarketplace {
	if o == nil || IsNil(o.Marketplace) {
		var ret CatalogV1alpha1ApplicationMarketplace
		return ret
	}
...
// SetMarketplace gets a reference to the given CatalogV1alpha1ApplicationMarketplace and assigns it to the Marketplace field.
...
func (o *CatalogV1alpha1Application) GetState() CatalogV1alpha1ApplicationState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1ApplicationState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1ApplicationState and assigns it to the State field.
...
func (o CatalogV1alpha1Application) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Application) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Application) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Application := _CatalogV1alpha1Application{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Application)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Application(varCatalogV1alpha1Application)

	return err
}

type NullableCatalogV1alpha1Application struct {
	value *CatalogV1alpha1Application
	isSet bool
}

func (v NullableCatalogV1alpha1Application) Get() *CatalogV1alpha1Application {
	return v.value
}

func (v *NullableCatalogV1alpha1Application) Set(val *CatalogV1alpha1Application) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Application) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Application) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Application(val *CatalogV1alpha1Application) *NullableCatalogV1alpha1Application {
	return &NullableCatalogV1alpha1Application{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Application) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Application) UnmarshalJSON(src []byte) error {
	v.isSet = true
