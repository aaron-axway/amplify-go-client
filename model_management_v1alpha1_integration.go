...
// checks if the ManagementV1alpha1Integration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1Integration{}

// ManagementV1alpha1Integration Definition of Integration for version v1alpha1 in group management.    Resource representing a group of integration resources.
type ManagementV1alpha1Integration struct {
	...
	// Resource of kind Integration. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Integration. Integration name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec ManagementV1alpha1IntegrationSpec `json:"spec"`
...
type _ManagementV1alpha1Integration ManagementV1alpha1Integration
...
func NewManagementV1alpha1Integration(spec ManagementV1alpha1IntegrationSpec) *ManagementV1alpha1Integration {
	this := ManagementV1alpha1Integration{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1Integration) GetSpec() ManagementV1alpha1IntegrationSpec {
	if o == nil {
		var ret ManagementV1alpha1IntegrationSpec
		return ret
	}
...
func (o ManagementV1alpha1Integration) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1Integration) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1Integration) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1Integration := _ManagementV1alpha1Integration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1Integration)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1Integration(varManagementV1alpha1Integration)

	return err
}

type NullableManagementV1alpha1Integration struct {
	value *ManagementV1alpha1Integration
	isSet bool
}

func (v NullableManagementV1alpha1Integration) Get() *ManagementV1alpha1Integration {
	return v.value
}

func (v *NullableManagementV1alpha1Integration) Set(val *ManagementV1alpha1Integration) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1Integration) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1Integration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1Integration(val *ManagementV1alpha1Integration) *NullableManagementV1alpha1Integration {
	return &NullableManagementV1alpha1Integration{value: val, isSet: true}
}

func (v NullableManagementV1alpha1Integration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1Integration) UnmarshalJSON(src []byte) error {
	v.isSet = true
