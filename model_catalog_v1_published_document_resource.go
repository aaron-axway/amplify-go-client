...
// checks if the CatalogV1PublishedDocumentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1PublishedDocumentResource{}

// CatalogV1PublishedDocumentResource Definition of PublishedDocumentResource for version v1 in group catalog.    Resource representing a Published DocumentResource into a Marketplace
type CatalogV1PublishedDocumentResource struct {
	...
	Spec CatalogV1PublishedDocumentResourceSpec `json:"spec"`
...
type _CatalogV1PublishedDocumentResource CatalogV1PublishedDocumentResource
...
func NewCatalogV1PublishedDocumentResource(spec CatalogV1PublishedDocumentResourceSpec) *CatalogV1PublishedDocumentResource {
	this := CatalogV1PublishedDocumentResource{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1PublishedDocumentResource) GetSpec() CatalogV1PublishedDocumentResourceSpec {
	if o == nil {
		var ret CatalogV1PublishedDocumentResourceSpec
		return ret
	}
...
func (o CatalogV1PublishedDocumentResource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1PublishedDocumentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1PublishedDocumentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1PublishedDocumentResource := _CatalogV1PublishedDocumentResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1PublishedDocumentResource)

	if err != nil {
		return err
	}

	*o = CatalogV1PublishedDocumentResource(varCatalogV1PublishedDocumentResource)

	return err
}

type NullableCatalogV1PublishedDocumentResource struct {
	value *CatalogV1PublishedDocumentResource
	isSet bool
}

func (v NullableCatalogV1PublishedDocumentResource) Get() *CatalogV1PublishedDocumentResource {
	return v.value
}

func (v *NullableCatalogV1PublishedDocumentResource) Set(val *CatalogV1PublishedDocumentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1PublishedDocumentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1PublishedDocumentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1PublishedDocumentResource(val *CatalogV1PublishedDocumentResource) *NullableCatalogV1PublishedDocumentResource {
	return &NullableCatalogV1PublishedDocumentResource{value: val, isSet: true}
}

func (v NullableCatalogV1PublishedDocumentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1PublishedDocumentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
