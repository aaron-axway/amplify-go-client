...
// checks if the ManagementV1alpha1AssetMappingTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AssetMappingTemplate{}

// ManagementV1alpha1AssetMappingTemplate Definition of AssetMappingTemplate for version v1alpha1 in group management.    An AssetMappingTemplate to detect and automatically promote APIServices to the assets catalog model.
type ManagementV1alpha1AssetMappingTemplate struct {
	...
	// Resource of kind AssetMappingTemplate. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the AssetMappingTemplate. AssetMappingTemplate name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the AssetMappingTemplate.
	...
	Spec ManagementV1alpha1AssetMappingTemplateSpec `json:"spec"`
...
type _ManagementV1alpha1AssetMappingTemplate ManagementV1alpha1AssetMappingTemplate
...
func NewManagementV1alpha1AssetMappingTemplate(spec ManagementV1alpha1AssetMappingTemplateSpec) *ManagementV1alpha1AssetMappingTemplate {
	this := ManagementV1alpha1AssetMappingTemplate{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1AssetMappingTemplate) GetSpec() ManagementV1alpha1AssetMappingTemplateSpec {
	if o == nil {
		var ret ManagementV1alpha1AssetMappingTemplateSpec
		return ret
	}
...
func (o ManagementV1alpha1AssetMappingTemplate) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AssetMappingTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1AssetMappingTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1AssetMappingTemplate := _ManagementV1alpha1AssetMappingTemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1AssetMappingTemplate)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1AssetMappingTemplate(varManagementV1alpha1AssetMappingTemplate)

	return err
}

type NullableManagementV1alpha1AssetMappingTemplate struct {
	value *ManagementV1alpha1AssetMappingTemplate
	isSet bool
}

func (v NullableManagementV1alpha1AssetMappingTemplate) Get() *ManagementV1alpha1AssetMappingTemplate {
	return v.value
}

func (v *NullableManagementV1alpha1AssetMappingTemplate) Set(val *ManagementV1alpha1AssetMappingTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AssetMappingTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AssetMappingTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AssetMappingTemplate(val *ManagementV1alpha1AssetMappingTemplate) *NullableManagementV1alpha1AssetMappingTemplate {
	return &NullableManagementV1alpha1AssetMappingTemplate{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AssetMappingTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AssetMappingTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
