...
// checks if the CatalogV1alpha1ConsumerProductVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ConsumerProductVisibility{}

// CatalogV1alpha1ConsumerProductVisibility Definition of ConsumerProductVisibility for version v1alpha1 in group catalog.    Resource representing Products visibility settings in the Marketplace for Consumer Organizations.
type CatalogV1alpha1ConsumerProductVisibility struct {
	...
	// Resource of kind ConsumerProductVisibility. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ConsumerProductVisibility. ConsumerProductVisibility name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ConsumerProductVisibility.
	...
	Spec CatalogV1alpha1ConsumerProductVisibilitySpec `json:"spec"`
...
type _CatalogV1alpha1ConsumerProductVisibility CatalogV1alpha1ConsumerProductVisibility
...
func NewCatalogV1alpha1ConsumerProductVisibility(spec CatalogV1alpha1ConsumerProductVisibilitySpec) *CatalogV1alpha1ConsumerProductVisibility {
	this := CatalogV1alpha1ConsumerProductVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ConsumerProductVisibility) GetSpec() CatalogV1alpha1ConsumerProductVisibilitySpec {
	if o == nil {
		var ret CatalogV1alpha1ConsumerProductVisibilitySpec
		return ret
	}
...
func (o CatalogV1alpha1ConsumerProductVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ConsumerProductVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ConsumerProductVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ConsumerProductVisibility := _CatalogV1alpha1ConsumerProductVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ConsumerProductVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ConsumerProductVisibility(varCatalogV1alpha1ConsumerProductVisibility)

	return err
}

type NullableCatalogV1alpha1ConsumerProductVisibility struct {
	value *CatalogV1alpha1ConsumerProductVisibility
	isSet bool
}

func (v NullableCatalogV1alpha1ConsumerProductVisibility) Get() *CatalogV1alpha1ConsumerProductVisibility {
	return v.value
}

func (v *NullableCatalogV1alpha1ConsumerProductVisibility) Set(val *CatalogV1alpha1ConsumerProductVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ConsumerProductVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ConsumerProductVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ConsumerProductVisibility(val *CatalogV1alpha1ConsumerProductVisibility) *NullableCatalogV1alpha1ConsumerProductVisibility {
	return &NullableCatalogV1alpha1ConsumerProductVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ConsumerProductVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ConsumerProductVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
