...
// checks if the CatalogV1alpha1PublishedStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1PublishedStage{}

// CatalogV1alpha1PublishedStage Definition of PublishedStage for version v1alpha1 in group catalog.    Resource representing a Published Stage into a Marketplace
type CatalogV1alpha1PublishedStage struct {
	...
	// Resource of kind PublishedStage. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the PublishedStage. PublishedStage name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the PublishedStage.
	...
	Spec CatalogV1alpha1PublishedStageSpec `json:"spec"`
...
type _CatalogV1alpha1PublishedStage CatalogV1alpha1PublishedStage
...
func NewCatalogV1alpha1PublishedStage(spec CatalogV1alpha1PublishedStageSpec) *CatalogV1alpha1PublishedStage {
	this := CatalogV1alpha1PublishedStage{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1PublishedStage) GetSpec() CatalogV1alpha1PublishedStageSpec {
	if o == nil {
		var ret CatalogV1alpha1PublishedStageSpec
		return ret
	}
...
func (o CatalogV1alpha1PublishedStage) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1PublishedStage) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1PublishedStage) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1PublishedStage := _CatalogV1alpha1PublishedStage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1PublishedStage)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1PublishedStage(varCatalogV1alpha1PublishedStage)

	return err
}

type NullableCatalogV1alpha1PublishedStage struct {
	value *CatalogV1alpha1PublishedStage
	isSet bool
}

func (v NullableCatalogV1alpha1PublishedStage) Get() *CatalogV1alpha1PublishedStage {
	return v.value
}

func (v *NullableCatalogV1alpha1PublishedStage) Set(val *CatalogV1alpha1PublishedStage) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1PublishedStage) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1PublishedStage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1PublishedStage(val *CatalogV1alpha1PublishedStage) *NullableCatalogV1alpha1PublishedStage {
	return &NullableCatalogV1alpha1PublishedStage{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1PublishedStage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1PublishedStage) UnmarshalJSON(src []byte) error {
	v.isSet = true
