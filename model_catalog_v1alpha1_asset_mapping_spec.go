...
// checks if the CatalogV1alpha1AssetMappingSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssetMappingSpec{}

// CatalogV1alpha1AssetMappingSpec struct for CatalogV1alpha1AssetMappingSpec
type CatalogV1alpha1AssetMappingSpec struct {
...
type _CatalogV1alpha1AssetMappingSpec CatalogV1alpha1AssetMappingSpec
...
func NewCatalogV1alpha1AssetMappingSpec(inputs CatalogV1alpha1AssetMappingSpecInputs) *CatalogV1alpha1AssetMappingSpec {
	this := CatalogV1alpha1AssetMappingSpec{}
	this.Inputs = inputs
	return &this
}
...
func (o CatalogV1alpha1AssetMappingSpec) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssetMappingSpec) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AssetMappingSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AssetMappingSpec := _CatalogV1alpha1AssetMappingSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AssetMappingSpec)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AssetMappingSpec(varCatalogV1alpha1AssetMappingSpec)

	return err
}

type NullableCatalogV1alpha1AssetMappingSpec struct {
	value *CatalogV1alpha1AssetMappingSpec
	isSet bool
}

func (v NullableCatalogV1alpha1AssetMappingSpec) Get() *CatalogV1alpha1AssetMappingSpec {
	return v.value
}

func (v *NullableCatalogV1alpha1AssetMappingSpec) Set(val *CatalogV1alpha1AssetMappingSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssetMappingSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssetMappingSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssetMappingSpec(val *CatalogV1alpha1AssetMappingSpec) *NullableCatalogV1alpha1AssetMappingSpec {
	return &NullableCatalogV1alpha1AssetMappingSpec{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssetMappingSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssetMappingSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
