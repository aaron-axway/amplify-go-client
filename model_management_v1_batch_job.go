...
// checks if the ManagementV1BatchJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1BatchJob{}

// ManagementV1BatchJob Definition of BatchJob for version v1 in group management.    Internal resource used by controllers to store the progress of long running jobs that can potentially iterate over thousands of resources. This resource is only accessible to the backend.
type ManagementV1BatchJob struct {
	...
	Spec ManagementV1BatchJobSpec `json:"spec"`
	Progress *ManagementV1BatchJobProgress `json:"progress,omitempty"`
...
type _ManagementV1BatchJob ManagementV1BatchJob
...
func (o *ManagementV1BatchJob) GetSpec() ManagementV1BatchJobSpec {
	if o == nil {
		var ret ManagementV1BatchJobSpec
		return ret
	}
...
func (o *ManagementV1BatchJob) GetProgress() ManagementV1BatchJobProgress {
	if o == nil || IsNil(o.Progress) {
		var ret ManagementV1BatchJobProgress
		return ret
	}
	return *o.Progress
}
...
// SetProgress gets a reference to the given ManagementV1BatchJobProgress and assigns it to the Progress field.
...
func (o ManagementV1BatchJob) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1BatchJob) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1BatchJob) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1BatchJob := _ManagementV1BatchJob{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1BatchJob)

	if err != nil {
		return err
	}

	*o = ManagementV1BatchJob(varManagementV1BatchJob)

	return err
}

type NullableManagementV1BatchJob struct {
	value *ManagementV1BatchJob
	isSet bool
}

func (v NullableManagementV1BatchJob) Get() *ManagementV1BatchJob {
	return v.value
}

func (v *NullableManagementV1BatchJob) Set(val *ManagementV1BatchJob) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1BatchJob) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1BatchJob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1BatchJob(val *ManagementV1BatchJob) *NullableManagementV1BatchJob {
	return &NullableManagementV1BatchJob{value: val, isSet: true}
}

func (v NullableManagementV1BatchJob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1BatchJob) UnmarshalJSON(src []byte) error {
	v.isSet = true
