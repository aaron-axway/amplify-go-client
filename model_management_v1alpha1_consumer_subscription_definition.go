...
// checks if the ManagementV1alpha1ConsumerSubscriptionDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1ConsumerSubscriptionDefinition{}

// ManagementV1alpha1ConsumerSubscriptionDefinition Definition of ConsumerSubscriptionDefinition for version v1alpha1 in group management.    Resource representing a Unified Catalog Item of type API.
type ManagementV1alpha1ConsumerSubscriptionDefinition struct {
	...
	// Name of the ConsumerSubscriptionDefinition. ConsumerSubscriptionDefinition name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
...
type _ManagementV1alpha1ConsumerSubscriptionDefinition ManagementV1alpha1ConsumerSubscriptionDefinition
...
func NewManagementV1alpha1ConsumerSubscriptionDefinition(spec ManagementV1alpha1ConsumerSubscriptionDefinitionSpec) *ManagementV1alpha1ConsumerSubscriptionDefinition {
	this := ManagementV1alpha1ConsumerSubscriptionDefinition{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1ConsumerSubscriptionDefinition) GetSpec() ManagementV1alpha1ConsumerSubscriptionDefinitionSpec {
	if o == nil {
		var ret ManagementV1alpha1ConsumerSubscriptionDefinitionSpec
		return ret
	}
...
func (o ManagementV1alpha1ConsumerSubscriptionDefinition) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1ConsumerSubscriptionDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1ConsumerSubscriptionDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1ConsumerSubscriptionDefinition := _ManagementV1alpha1ConsumerSubscriptionDefinition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1ConsumerSubscriptionDefinition)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1ConsumerSubscriptionDefinition(varManagementV1alpha1ConsumerSubscriptionDefinition)

	return err
}

type NullableManagementV1alpha1ConsumerSubscriptionDefinition struct {
	value *ManagementV1alpha1ConsumerSubscriptionDefinition
	isSet bool
}

func (v NullableManagementV1alpha1ConsumerSubscriptionDefinition) Get() *ManagementV1alpha1ConsumerSubscriptionDefinition {
	return v.value
}

func (v *NullableManagementV1alpha1ConsumerSubscriptionDefinition) Set(val *ManagementV1alpha1ConsumerSubscriptionDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1ConsumerSubscriptionDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1ConsumerSubscriptionDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1ConsumerSubscriptionDefinition(val *ManagementV1alpha1ConsumerSubscriptionDefinition) *NullableManagementV1alpha1ConsumerSubscriptionDefinition {
	return &NullableManagementV1alpha1ConsumerSubscriptionDefinition{value: val, isSet: true}
}

func (v NullableManagementV1alpha1ConsumerSubscriptionDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1ConsumerSubscriptionDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
