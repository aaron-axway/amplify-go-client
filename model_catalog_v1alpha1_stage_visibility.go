...
// checks if the CatalogV1alpha1StageVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1StageVisibility{}

// CatalogV1alpha1StageVisibility Definition of StageVisibility for version v1alpha1 in group catalog.    Resource representing Stage visibility settings in the Marketplace
type CatalogV1alpha1StageVisibility struct {
	...
	// Resource of kind StageVisibility. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the StageVisibility. StageVisibility name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the StageVisibility.
	...
	Spec CatalogV1alpha1StageVisibilitySpec `json:"spec"`
...
type _CatalogV1alpha1StageVisibility CatalogV1alpha1StageVisibility
...
func NewCatalogV1alpha1StageVisibility(spec CatalogV1alpha1StageVisibilitySpec) *CatalogV1alpha1StageVisibility {
	this := CatalogV1alpha1StageVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1StageVisibility) GetSpec() CatalogV1alpha1StageVisibilitySpec {
	if o == nil {
		var ret CatalogV1alpha1StageVisibilitySpec
		return ret
	}
...
func (o CatalogV1alpha1StageVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1StageVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1StageVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1StageVisibility := _CatalogV1alpha1StageVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1StageVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1StageVisibility(varCatalogV1alpha1StageVisibility)

	return err
}

type NullableCatalogV1alpha1StageVisibility struct {
	value *CatalogV1alpha1StageVisibility
	isSet bool
}

func (v NullableCatalogV1alpha1StageVisibility) Get() *CatalogV1alpha1StageVisibility {
	return v.value
}

func (v *NullableCatalogV1alpha1StageVisibility) Set(val *CatalogV1alpha1StageVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1StageVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1StageVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1StageVisibility(val *CatalogV1alpha1StageVisibility) *NullableCatalogV1alpha1StageVisibility {
	return &NullableCatalogV1alpha1StageVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1StageVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1StageVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
