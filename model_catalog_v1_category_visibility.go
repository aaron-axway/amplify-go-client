...
// checks if the CatalogV1CategoryVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1CategoryVisibility{}

// CatalogV1CategoryVisibility Definition of CategoryVisibility for version v1 in group catalog.    Resource representing a Category visibility settings in the Marketplace.
type CatalogV1CategoryVisibility struct {
	...
	Spec CatalogV1CategoryVisibilitySpec `json:"spec"`
...
type _CatalogV1CategoryVisibility CatalogV1CategoryVisibility
...
func NewCatalogV1CategoryVisibility(spec CatalogV1CategoryVisibilitySpec) *CatalogV1CategoryVisibility {
	this := CatalogV1CategoryVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1CategoryVisibility) GetSpec() CatalogV1CategoryVisibilitySpec {
	if o == nil {
		var ret CatalogV1CategoryVisibilitySpec
		return ret
	}
...
func (o CatalogV1CategoryVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1CategoryVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1CategoryVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1CategoryVisibility := _CatalogV1CategoryVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1CategoryVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1CategoryVisibility(varCatalogV1CategoryVisibility)

	return err
}

type NullableCatalogV1CategoryVisibility struct {
	value *CatalogV1CategoryVisibility
	isSet bool
}

func (v NullableCatalogV1CategoryVisibility) Get() *CatalogV1CategoryVisibility {
	return v.value
}

func (v *NullableCatalogV1CategoryVisibility) Set(val *CatalogV1CategoryVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1CategoryVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1CategoryVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1CategoryVisibility(val *CatalogV1CategoryVisibility) *NullableCatalogV1CategoryVisibility {
	return &NullableCatalogV1CategoryVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1CategoryVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1CategoryVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
