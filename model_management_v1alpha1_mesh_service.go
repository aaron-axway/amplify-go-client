...
// checks if the ManagementV1alpha1MeshService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1MeshService{}

// ManagementV1alpha1MeshService Definition of MeshService for version v1alpha1 in group management.    A MeshService aggregates all apis exposed by workloads under the same authority.
type ManagementV1alpha1MeshService struct {
	...
	// Resource of kind MeshService. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the MeshService. MeshService name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the MeshService.
	...
	Spec ManagementV1alpha1MeshServiceSpec `json:"spec"`
...
type _ManagementV1alpha1MeshService ManagementV1alpha1MeshService
...
func NewManagementV1alpha1MeshService(spec ManagementV1alpha1MeshServiceSpec) *ManagementV1alpha1MeshService {
	this := ManagementV1alpha1MeshService{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1MeshService) GetSpec() ManagementV1alpha1MeshServiceSpec {
	if o == nil {
		var ret ManagementV1alpha1MeshServiceSpec
		return ret
	}
...
func (o ManagementV1alpha1MeshService) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1MeshService) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1MeshService) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1MeshService := _ManagementV1alpha1MeshService{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1MeshService)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1MeshService(varManagementV1alpha1MeshService)

	return err
}

type NullableManagementV1alpha1MeshService struct {
	value *ManagementV1alpha1MeshService
	isSet bool
}

func (v NullableManagementV1alpha1MeshService) Get() *ManagementV1alpha1MeshService {
	return v.value
}

func (v *NullableManagementV1alpha1MeshService) Set(val *ManagementV1alpha1MeshService) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1MeshService) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1MeshService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1MeshService(val *ManagementV1alpha1MeshService) *NullableManagementV1alpha1MeshService {
	return &NullableManagementV1alpha1MeshService{value: val, isSet: true}
}

func (v NullableManagementV1alpha1MeshService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1MeshService) UnmarshalJSON(src []byte) error {
	v.isSet = true
