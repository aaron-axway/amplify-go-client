...
// checks if the CatalogV1alpha1ProductPlanJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductPlanJob{}

// CatalogV1alpha1ProductPlanJob Definition of ProductPlanJob for version v1alpha1 in group catalog.    Resource representing an job to be executed on a Product Plan.
type CatalogV1alpha1ProductPlanJob struct {
	...
	// Resource of kind ProductPlanJob. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductPlanJob. ProductPlanJob name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductPlanJob.
	...
	Spec CatalogV1alpha1ProductPlanJobSpec `json:"spec"`
	Status *CatalogV1alpha1ProductPlanJobStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1ProductPlanJob CatalogV1alpha1ProductPlanJob
...
func NewCatalogV1alpha1ProductPlanJob(spec CatalogV1alpha1ProductPlanJobSpec) *CatalogV1alpha1ProductPlanJob {
	this := CatalogV1alpha1ProductPlanJob{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductPlanJob) GetSpec() CatalogV1alpha1ProductPlanJobSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductPlanJobSpec
		return ret
	}
...
func (o *CatalogV1alpha1ProductPlanJob) GetStatus() CatalogV1alpha1ProductPlanJobStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1ProductPlanJobStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1ProductPlanJobStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1ProductPlanJob) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductPlanJob) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductPlanJob) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductPlanJob := _CatalogV1alpha1ProductPlanJob{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductPlanJob)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductPlanJob(varCatalogV1alpha1ProductPlanJob)

	return err
}

type NullableCatalogV1alpha1ProductPlanJob struct {
	value *CatalogV1alpha1ProductPlanJob
	isSet bool
}

func (v NullableCatalogV1alpha1ProductPlanJob) Get() *CatalogV1alpha1ProductPlanJob {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductPlanJob) Set(val *CatalogV1alpha1ProductPlanJob) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductPlanJob) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductPlanJob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductPlanJob(val *CatalogV1alpha1ProductPlanJob) *NullableCatalogV1alpha1ProductPlanJob {
	return &NullableCatalogV1alpha1ProductPlanJob{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductPlanJob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductPlanJob) UnmarshalJSON(src []byte) error {
	v.isSet = true
