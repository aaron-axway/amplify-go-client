...
// checks if the CatalogV1ProductOverview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1ProductOverview{}

// CatalogV1ProductOverview Definition of ProductOverview for version v1 in group catalog.    Resource that defines the properties of the Product overview for Marketplace
type CatalogV1ProductOverview struct {
	...
	Spec CatalogV1ProductOverviewSpec `json:"spec"`
...
type _CatalogV1ProductOverview CatalogV1ProductOverview
...
func (o *CatalogV1ProductOverview) GetSpec() CatalogV1ProductOverviewSpec {
	if o == nil {
		var ret CatalogV1ProductOverviewSpec
		return ret
	}
...
func (o CatalogV1ProductOverview) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1ProductOverview) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1ProductOverview) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1ProductOverview := _CatalogV1ProductOverview{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1ProductOverview)

	if err != nil {
		return err
	}

	*o = CatalogV1ProductOverview(varCatalogV1ProductOverview)

	return err
}

type NullableCatalogV1ProductOverview struct {
	value *CatalogV1ProductOverview
	isSet bool
}

func (v NullableCatalogV1ProductOverview) Get() *CatalogV1ProductOverview {
	return v.value
}

func (v *NullableCatalogV1ProductOverview) Set(val *CatalogV1ProductOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1ProductOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1ProductOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1ProductOverview(val *CatalogV1ProductOverview) *NullableCatalogV1ProductOverview {
	return &NullableCatalogV1ProductOverview{value: val, isSet: true}
}

func (v NullableCatalogV1ProductOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1ProductOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
