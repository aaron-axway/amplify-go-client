...
// checks if the ManagementV1alpha1SpecDiscovery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1SpecDiscovery{}

// ManagementV1alpha1SpecDiscovery Definition of SpecDiscovery for version v1alpha1 in group management.    Configures API Discovery in a mesh.
type ManagementV1alpha1SpecDiscovery struct {
	...
	// Resource of kind SpecDiscovery. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the SpecDiscovery. SpecDiscovery name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the SpecDiscovery.
	...
	Spec ManagementV1alpha1SpecDiscoverySpec `json:"spec"`
...
type _ManagementV1alpha1SpecDiscovery ManagementV1alpha1SpecDiscovery
...
func NewManagementV1alpha1SpecDiscovery(spec ManagementV1alpha1SpecDiscoverySpec) *ManagementV1alpha1SpecDiscovery {
	this := ManagementV1alpha1SpecDiscovery{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1SpecDiscovery) GetSpec() ManagementV1alpha1SpecDiscoverySpec {
	if o == nil {
		var ret ManagementV1alpha1SpecDiscoverySpec
		return ret
	}
...
func (o ManagementV1alpha1SpecDiscovery) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1SpecDiscovery) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1SpecDiscovery) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1SpecDiscovery := _ManagementV1alpha1SpecDiscovery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1SpecDiscovery)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1SpecDiscovery(varManagementV1alpha1SpecDiscovery)

	return err
}

type NullableManagementV1alpha1SpecDiscovery struct {
	value *ManagementV1alpha1SpecDiscovery
	isSet bool
}

func (v NullableManagementV1alpha1SpecDiscovery) Get() *ManagementV1alpha1SpecDiscovery {
	return v.value
}

func (v *NullableManagementV1alpha1SpecDiscovery) Set(val *ManagementV1alpha1SpecDiscovery) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1SpecDiscovery) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1SpecDiscovery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1SpecDiscovery(val *ManagementV1alpha1SpecDiscovery) *NullableManagementV1alpha1SpecDiscovery {
	return &NullableManagementV1alpha1SpecDiscovery{value: val, isSet: true}
}

func (v NullableManagementV1alpha1SpecDiscovery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1SpecDiscovery) UnmarshalJSON(src []byte) error {
	v.isSet = true
