...
// checks if the CatalogV1alpha1ProductPlanUnit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductPlanUnit{}

// CatalogV1alpha1ProductPlanUnit Definition of ProductPlanUnit for version v1alpha1 in group catalog.    Resource representing an Amplify Central Product Plan Unit.
type CatalogV1alpha1ProductPlanUnit struct {
	...
	// Resource of kind ProductPlanUnit. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductPlanUnit. ProductPlanUnit name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductPlanUnit.
	...
	Spec CatalogV1alpha1ProductPlanUnitSpec `json:"spec"`
...
type _CatalogV1alpha1ProductPlanUnit CatalogV1alpha1ProductPlanUnit
...
func NewCatalogV1alpha1ProductPlanUnit(spec CatalogV1alpha1ProductPlanUnitSpec) *CatalogV1alpha1ProductPlanUnit {
	this := CatalogV1alpha1ProductPlanUnit{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductPlanUnit) GetSpec() CatalogV1alpha1ProductPlanUnitSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductPlanUnitSpec
		return ret
	}
...
func (o CatalogV1alpha1ProductPlanUnit) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductPlanUnit) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductPlanUnit) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductPlanUnit := _CatalogV1alpha1ProductPlanUnit{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductPlanUnit)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductPlanUnit(varCatalogV1alpha1ProductPlanUnit)

	return err
}

type NullableCatalogV1alpha1ProductPlanUnit struct {
	value *CatalogV1alpha1ProductPlanUnit
	isSet bool
}

func (v NullableCatalogV1alpha1ProductPlanUnit) Get() *CatalogV1alpha1ProductPlanUnit {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductPlanUnit) Set(val *CatalogV1alpha1ProductPlanUnit) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductPlanUnit) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductPlanUnit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductPlanUnit(val *CatalogV1alpha1ProductPlanUnit) *NullableCatalogV1alpha1ProductPlanUnit {
	return &NullableCatalogV1alpha1ProductPlanUnit{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductPlanUnit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductPlanUnit) UnmarshalJSON(src []byte) error {
	v.isSet = true
