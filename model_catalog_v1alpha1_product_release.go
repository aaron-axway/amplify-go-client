...
// checks if the CatalogV1alpha1ProductRelease type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductRelease{}

// CatalogV1alpha1ProductRelease Definition of ProductRelease for version v1alpha1 in group catalog.    Resource representing a Product release.
type CatalogV1alpha1ProductRelease struct {
	...
	// Resource of kind ProductRelease. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductRelease. ProductRelease name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductRelease.
	...
	Spec CatalogV1alpha1ProductReleaseSpec `json:"spec"`
	References *CatalogV1alpha1ProductReleaseReferences `json:"references,omitempty"`
	// Image for the ProductRelease expressed as a Data-Uri (https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs)
	Icon *string `json:"icon,omitempty" validate:"regexp=^data:((?:\\\\w+\\/(?:(?!;).)+)?)((?:;[\\\\w\\\\W]*?[^;])*),(.+)$"`
	Status *CatalogV1alpha1ProductReleaseStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1ProductRelease CatalogV1alpha1ProductRelease
...
func NewCatalogV1alpha1ProductRelease(spec CatalogV1alpha1ProductReleaseSpec) *CatalogV1alpha1ProductRelease {
	this := CatalogV1alpha1ProductRelease{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductRelease) GetSpec() CatalogV1alpha1ProductReleaseSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductReleaseSpec
		return ret
	}
...
func (o *CatalogV1alpha1ProductRelease) GetReferences() CatalogV1alpha1ProductReleaseReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1alpha1ProductReleaseReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1alpha1ProductReleaseReferences and assigns it to the References field.
...
func (o *CatalogV1alpha1ProductRelease) GetStatus() CatalogV1alpha1ProductReleaseStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1ProductReleaseStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1ProductReleaseStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1ProductRelease) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductRelease) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductRelease) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductRelease := _CatalogV1alpha1ProductRelease{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductRelease)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductRelease(varCatalogV1alpha1ProductRelease)

	return err
}

type NullableCatalogV1alpha1ProductRelease struct {
	value *CatalogV1alpha1ProductRelease
	isSet bool
}

func (v NullableCatalogV1alpha1ProductRelease) Get() *CatalogV1alpha1ProductRelease {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductRelease) Set(val *CatalogV1alpha1ProductRelease) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductRelease) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductRelease) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductRelease(val *CatalogV1alpha1ProductRelease) *NullableCatalogV1alpha1ProductRelease {
	return &NullableCatalogV1alpha1ProductRelease{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductRelease) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductRelease) UnmarshalJSON(src []byte) error {
	v.isSet = true
