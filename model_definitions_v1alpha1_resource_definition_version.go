...
// checks if the DefinitionsV1alpha1ResourceDefinitionVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefinitionsV1alpha1ResourceDefinitionVersion{}

// DefinitionsV1alpha1ResourceDefinitionVersion Definition of ResourceDefinitionVersion for version v1alpha1 in group definitions.    Resource representing the structure of a version for the referenced API Server Resource in a group.
type DefinitionsV1alpha1ResourceDefinitionVersion struct {
	...
	// Name of the ResourceDefinitionVersion. ResourceDefinitionVersion name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
...
type _DefinitionsV1alpha1ResourceDefinitionVersion DefinitionsV1alpha1ResourceDefinitionVersion
...
func NewDefinitionsV1alpha1ResourceDefinitionVersion(spec DefinitionsV1alpha1ResourceDefinitionVersionSpec) *DefinitionsV1alpha1ResourceDefinitionVersion {
	this := DefinitionsV1alpha1ResourceDefinitionVersion{}
	this.Spec = spec
	return &this
}
...
func (o *DefinitionsV1alpha1ResourceDefinitionVersion) GetSpec() DefinitionsV1alpha1ResourceDefinitionVersionSpec {
	if o == nil {
		var ret DefinitionsV1alpha1ResourceDefinitionVersionSpec
		return ret
	}
...
func (o DefinitionsV1alpha1ResourceDefinitionVersion) MarshalJSON() ([]byte, error) {
...
func (o DefinitionsV1alpha1ResourceDefinitionVersion) ToMap() (map[string]interface{}, error) {
...
func (o *DefinitionsV1alpha1ResourceDefinitionVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varDefinitionsV1alpha1ResourceDefinitionVersion := _DefinitionsV1alpha1ResourceDefinitionVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDefinitionsV1alpha1ResourceDefinitionVersion)

	if err != nil {
		return err
	}

	*o = DefinitionsV1alpha1ResourceDefinitionVersion(varDefinitionsV1alpha1ResourceDefinitionVersion)

	return err
}

type NullableDefinitionsV1alpha1ResourceDefinitionVersion struct {
	value *DefinitionsV1alpha1ResourceDefinitionVersion
	isSet bool
}

func (v NullableDefinitionsV1alpha1ResourceDefinitionVersion) Get() *DefinitionsV1alpha1ResourceDefinitionVersion {
	return v.value
}

func (v *NullableDefinitionsV1alpha1ResourceDefinitionVersion) Set(val *DefinitionsV1alpha1ResourceDefinitionVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableDefinitionsV1alpha1ResourceDefinitionVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableDefinitionsV1alpha1ResourceDefinitionVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefinitionsV1alpha1ResourceDefinitionVersion(val *DefinitionsV1alpha1ResourceDefinitionVersion) *NullableDefinitionsV1alpha1ResourceDefinitionVersion {
	return &NullableDefinitionsV1alpha1ResourceDefinitionVersion{value: val, isSet: true}
}

func (v NullableDefinitionsV1alpha1ResourceDefinitionVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefinitionsV1alpha1ResourceDefinitionVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
