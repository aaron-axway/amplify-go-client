...
// checks if the CatalogV1alpha1Subscription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Subscription{}

// CatalogV1alpha1Subscription Definition of Subscription for version v1alpha1 in group catalog.    Defines the subscription.
type CatalogV1alpha1Subscription struct {
	...
	// Resource of kind Subscription. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Subscription. Subscription name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1alpha1SubscriptionSpec `json:"spec"`
	Billing *CatalogV1alpha1SubscriptionBilling `json:"billing,omitempty"`
	Marketplace *CatalogV1alpha1SubscriptionMarketplace `json:"marketplace,omitempty"`
	Approval *CatalogV1alpha1SubscriptionApproval `json:"approval,omitempty"`
	Status *CatalogV1alpha1SubscriptionStatus `json:"status,omitempty"`
	References *CatalogV1alpha1SubscriptionReferences `json:"references,omitempty"`
	State *CatalogV1alpha1SubscriptionState `json:"state,omitempty"`
...
type _CatalogV1alpha1Subscription CatalogV1alpha1Subscription
...
func NewCatalogV1alpha1Subscription(spec CatalogV1alpha1SubscriptionSpec) *CatalogV1alpha1Subscription {
	this := CatalogV1alpha1Subscription{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1Subscription) GetSpec() CatalogV1alpha1SubscriptionSpec {
	if o == nil {
		var ret CatalogV1alpha1SubscriptionSpec
		return ret
	}
...
func (o *CatalogV1alpha1Subscription) GetBilling() CatalogV1alpha1SubscriptionBilling {
	if o == nil || IsNil(o.Billing) {
		var ret CatalogV1alpha1SubscriptionBilling
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given CatalogV1alpha1SubscriptionBilling and assigns it to the Billing field.
...
func (o *CatalogV1alpha1Subscription) GetMarketplace() CatalogV1alpha1SubscriptionMarketplace {
	if o == nil || IsNil(o.Marketplace) {
		var ret CatalogV1alpha1SubscriptionMarketplace
		return ret
	}
...
// SetMarketplace gets a reference to the given CatalogV1alpha1SubscriptionMarketplace and assigns it to the Marketplace field.
...
func (o *CatalogV1alpha1Subscription) GetApproval() CatalogV1alpha1SubscriptionApproval {
	if o == nil || IsNil(o.Approval) {
		var ret CatalogV1alpha1SubscriptionApproval
		return ret
	}
	return *o.Approval
}
...
// SetApproval gets a reference to the given CatalogV1alpha1SubscriptionApproval and assigns it to the Approval field.
...
func (o *CatalogV1alpha1Subscription) GetStatus() CatalogV1alpha1SubscriptionStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1SubscriptionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1SubscriptionStatus and assigns it to the Status field.
...
func (o *CatalogV1alpha1Subscription) GetReferences() CatalogV1alpha1SubscriptionReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1alpha1SubscriptionReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1alpha1SubscriptionReferences and assigns it to the References field.
...
func (o *CatalogV1alpha1Subscription) GetState() CatalogV1alpha1SubscriptionState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1SubscriptionState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1SubscriptionState and assigns it to the State field.
...
func (o CatalogV1alpha1Subscription) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Subscription) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Subscription) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Subscription := _CatalogV1alpha1Subscription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Subscription)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Subscription(varCatalogV1alpha1Subscription)

	return err
}

type NullableCatalogV1alpha1Subscription struct {
	value *CatalogV1alpha1Subscription
	isSet bool
}

func (v NullableCatalogV1alpha1Subscription) Get() *CatalogV1alpha1Subscription {
	return v.value
}

func (v *NullableCatalogV1alpha1Subscription) Set(val *CatalogV1alpha1Subscription) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Subscription) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Subscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Subscription(val *CatalogV1alpha1Subscription) *NullableCatalogV1alpha1Subscription {
	return &NullableCatalogV1alpha1Subscription{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Subscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Subscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
