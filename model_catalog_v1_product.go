...
// checks if the CatalogV1Product type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1Product{}

// CatalogV1Product Definition of Product for version v1 in group catalog.    Resource representing an Amplify Central Product in the Products Catalog.
type CatalogV1Product struct {
	...
	// Resource of kind Product. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Product. Product name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1ProductSpec `json:"spec"`
	// Image for the Product expressed as a Data-Uri (https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs)
	Icon *string `json:"icon,omitempty" validate:"regexp=^data:((?:\\\\w+\\/(?:(?!;).)+)?)((?:;[\\\\w\\\\W]*?[^;])*),(.+)$"`
	Latestrelease *CatalogV1ProductLatestrelease `json:"latestrelease,omitempty"`
	Status *CatalogV1ProductStatus `json:"status,omitempty"`
	State *CatalogV1ProductState `json:"state,omitempty"`
	References *CatalogV1ProductReferences `json:"references,omitempty"`
...
type _CatalogV1Product CatalogV1Product
...
func (o *CatalogV1Product) GetLatestrelease() CatalogV1ProductLatestrelease {
	if o == nil || IsNil(o.Latestrelease) {
		var ret CatalogV1ProductLatestrelease
		return ret
	}
...
// SetLatestrelease gets a reference to the given CatalogV1ProductLatestrelease and assigns it to the Latestrelease field.
...
func (o *CatalogV1Product) GetStatus() CatalogV1ProductStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1ProductStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1ProductStatus and assigns it to the Status field.
...
// SetState gets a reference to the given CatalogV1ProductState and assigns it to the State field.
...
func (o *CatalogV1Product) GetReferences() CatalogV1ProductReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1ProductReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1ProductReferences and assigns it to the References field.
...
func (o CatalogV1Product) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1Product) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1Product) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1Product := _CatalogV1Product{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1Product)

	if err != nil {
		return err
	}

	*o = CatalogV1Product(varCatalogV1Product)

	return err
}

type NullableCatalogV1Product struct {
	value *CatalogV1Product
	isSet bool
}

func (v NullableCatalogV1Product) Get() *CatalogV1Product {
	return v.value
}

func (v *NullableCatalogV1Product) Set(val *CatalogV1Product) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1Product) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1Product) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1Product(val *CatalogV1Product) *NullableCatalogV1Product {
	return &NullableCatalogV1Product{value: val, isSet: true}
}

func (v NullableCatalogV1Product) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1Product) UnmarshalJSON(src []byte) error {
	v.isSet = true
