...
// checks if the CatalogV1alpha1ProductReferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductReferences{}

// CatalogV1alpha1ProductReferences struct for CatalogV1alpha1ProductReferences
type CatalogV1alpha1ProductReferences struct {
...
func NewCatalogV1alpha1ProductReferences() *CatalogV1alpha1ProductReferences {
	this := CatalogV1alpha1ProductReferences{}
	return &this
}
...
func (o CatalogV1alpha1ProductReferences) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductReferences) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogV1alpha1ProductReferences struct {
	value *CatalogV1alpha1ProductReferences
	isSet bool
}

func (v NullableCatalogV1alpha1ProductReferences) Get() *CatalogV1alpha1ProductReferences {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductReferences) Set(val *CatalogV1alpha1ProductReferences) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductReferences) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductReferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductReferences(val *CatalogV1alpha1ProductReferences) *NullableCatalogV1alpha1ProductReferences {
	return &NullableCatalogV1alpha1ProductReferences{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductReferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductReferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
