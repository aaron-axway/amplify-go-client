...
// checks if the ManagementV1alpha1WatchTopic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1WatchTopic{}

// ManagementV1alpha1WatchTopic Definition of WatchTopic for version v1alpha1 in group management.    Resource representing a set of filters for the Agents to create a GRPC Watch stream
type ManagementV1alpha1WatchTopic struct {
	...
	// Resource of kind WatchTopic. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the WatchTopic. WatchTopic name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the WatchTopic.
	...
	Spec ManagementV1alpha1WatchTopicSpec `json:"spec"`
...
type _ManagementV1alpha1WatchTopic ManagementV1alpha1WatchTopic
...
func NewManagementV1alpha1WatchTopic(spec ManagementV1alpha1WatchTopicSpec) *ManagementV1alpha1WatchTopic {
	this := ManagementV1alpha1WatchTopic{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1WatchTopic) GetSpec() ManagementV1alpha1WatchTopicSpec {
	if o == nil {
		var ret ManagementV1alpha1WatchTopicSpec
		return ret
	}
...
func (o ManagementV1alpha1WatchTopic) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1WatchTopic) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1WatchTopic) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1WatchTopic := _ManagementV1alpha1WatchTopic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1WatchTopic)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1WatchTopic(varManagementV1alpha1WatchTopic)

	return err
}

type NullableManagementV1alpha1WatchTopic struct {
	value *ManagementV1alpha1WatchTopic
	isSet bool
}

func (v NullableManagementV1alpha1WatchTopic) Get() *ManagementV1alpha1WatchTopic {
	return v.value
}

func (v *NullableManagementV1alpha1WatchTopic) Set(val *ManagementV1alpha1WatchTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1WatchTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1WatchTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1WatchTopic(val *ManagementV1alpha1WatchTopic) *NullableManagementV1alpha1WatchTopic {
	return &NullableManagementV1alpha1WatchTopic{value: val, isSet: true}
}

func (v NullableManagementV1alpha1WatchTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1WatchTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
