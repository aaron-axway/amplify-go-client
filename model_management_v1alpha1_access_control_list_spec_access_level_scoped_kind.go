...
// checks if the ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind{}

// ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind struct for ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind
type ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind struct {
...
type _ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind
...
func NewManagementV1alpha1AccessControlListSpecAccessLevelScopedKind(kind string) *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind {
	this := ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind{}
	this.Kind = kind
	return &this
}
...
func (o ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1AccessControlListSpecAccessLevelScopedKind := _ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1AccessControlListSpecAccessLevelScopedKind)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind(varManagementV1alpha1AccessControlListSpecAccessLevelScopedKind)

	return err
}

type NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind struct {
	value *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind
	isSet bool
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) Get() *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind {
	return v.value
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) Set(val *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind(val *ManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind {
	return &NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AccessControlListSpecAccessLevelScopedKind) UnmarshalJSON(src []byte) error {
	v.isSet = true
