...
// checks if the ManagementV1alpha1Secret type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1Secret{}

// ManagementV1alpha1Secret Definition of Secret for version v1alpha1 in group management.    Secrets definitions.
...
type _ManagementV1alpha1Secret ManagementV1alpha1Secret
...
func (o *ManagementV1alpha1Secret) GetSpec() ManagementV1alpha1SecretSpec {
	if o == nil {
		var ret ManagementV1alpha1SecretSpec
		return ret
	}
...
func (o ManagementV1alpha1Secret) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1Secret) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1Secret) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1Secret := _ManagementV1alpha1Secret{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1Secret)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1Secret(varManagementV1alpha1Secret)

	return err
}

type NullableManagementV1alpha1Secret struct {
	value *ManagementV1alpha1Secret
	isSet bool
}

func (v NullableManagementV1alpha1Secret) Get() *ManagementV1alpha1Secret {
	return v.value
}

func (v *NullableManagementV1alpha1Secret) Set(val *ManagementV1alpha1Secret) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1Secret) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1Secret) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1Secret(val *ManagementV1alpha1Secret) *NullableManagementV1alpha1Secret {
	return &NullableManagementV1alpha1Secret{value: val, isSet: true}
}

func (v NullableManagementV1alpha1Secret) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1Secret) UnmarshalJSON(src []byte) error {
	v.isSet = true
