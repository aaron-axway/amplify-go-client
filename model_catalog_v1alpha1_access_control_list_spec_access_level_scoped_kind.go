...
// checks if the CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind{}

// CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind struct for CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind
type CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind struct {
...
type _CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind
...
func NewCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind(kind string) *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind {
	this := CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind{}
	this.Kind = kind
	return &this
}
...
func (o CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind := _CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind(varCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind)

	return err
}

type NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind struct {
	value *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind
	isSet bool
}

func (v NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) Get() *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind {
	return v.value
}

func (v *NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) Set(val *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind(val *CatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) *NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind {
	return &NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AccessControlListSpecAccessLevelScopedKind) UnmarshalJSON(src []byte) error {
	v.isSet = true
