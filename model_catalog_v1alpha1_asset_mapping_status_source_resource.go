...
// checks if the CatalogV1alpha1AssetMappingStatusSourceResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AssetMappingStatusSourceResource{}

// CatalogV1alpha1AssetMappingStatusSourceResource The resource that triggered the Asset Mapping.
type CatalogV1alpha1AssetMappingStatusSourceResource struct {
	ApiService *CatalogV1alpha1AssetMappingStatusSourceResourceApiService `json:"apiService,omitempty"`
	ApiServiceRevision *CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceRevision `json:"apiServiceRevision,omitempty"`
	ApiServiceInstance *CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceInstance `json:"apiServiceInstance,omitempty"`
	AssetMappingTemplate *CatalogV1alpha1AssetMappingStatusSourceResourceAssetMappingTemplate `json:"assetMappingTemplate,omitempty"`
}
...
func NewCatalogV1alpha1AssetMappingStatusSourceResource() *CatalogV1alpha1AssetMappingStatusSourceResource {
	this := CatalogV1alpha1AssetMappingStatusSourceResource{}
	return &this
}
...
func (o *CatalogV1alpha1AssetMappingStatusSourceResource) GetApiService() CatalogV1alpha1AssetMappingStatusSourceResourceApiService {
	if o == nil || IsNil(o.ApiService) {
		var ret CatalogV1alpha1AssetMappingStatusSourceResourceApiService
		return ret
	}
	return *o.ApiService
}
...
// SetApiService gets a reference to the given CatalogV1alpha1AssetMappingStatusSourceResourceApiService and assigns it to the ApiService field.
...
func (o *CatalogV1alpha1AssetMappingStatusSourceResource) GetApiServiceRevision() CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceRevision {
	if o == nil || IsNil(o.ApiServiceRevision) {
		var ret CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceRevision
		return ret
	}
...
// SetApiServiceRevision gets a reference to the given CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceRevision and assigns it to the ApiServiceRevision field.
...
func (o *CatalogV1alpha1AssetMappingStatusSourceResource) GetApiServiceInstance() CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceInstance {
	if o == nil || IsNil(o.ApiServiceInstance) {
		var ret CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceInstance
		return ret
	}
...
// SetApiServiceInstance gets a reference to the given CatalogV1alpha1AssetMappingStatusSourceResourceApiServiceInstance and assigns it to the ApiServiceInstance field.
...
func (o *CatalogV1alpha1AssetMappingStatusSourceResource) GetAssetMappingTemplate() CatalogV1alpha1AssetMappingStatusSourceResourceAssetMappingTemplate {
	if o == nil || IsNil(o.AssetMappingTemplate) {
		var ret CatalogV1alpha1AssetMappingStatusSourceResourceAssetMappingTemplate
		return ret
	}
...
// SetAssetMappingTemplate gets a reference to the given CatalogV1alpha1AssetMappingStatusSourceResourceAssetMappingTemplate and assigns it to the AssetMappingTemplate field.
...
func (o CatalogV1alpha1AssetMappingStatusSourceResource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AssetMappingStatusSourceResource) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogV1alpha1AssetMappingStatusSourceResource struct {
	value *CatalogV1alpha1AssetMappingStatusSourceResource
	isSet bool
}

func (v NullableCatalogV1alpha1AssetMappingStatusSourceResource) Get() *CatalogV1alpha1AssetMappingStatusSourceResource {
	return v.value
}

func (v *NullableCatalogV1alpha1AssetMappingStatusSourceResource) Set(val *CatalogV1alpha1AssetMappingStatusSourceResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AssetMappingStatusSourceResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AssetMappingStatusSourceResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AssetMappingStatusSourceResource(val *CatalogV1alpha1AssetMappingStatusSourceResource) *NullableCatalogV1alpha1AssetMappingStatusSourceResource {
	return &NullableCatalogV1alpha1AssetMappingStatusSourceResource{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AssetMappingStatusSourceResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AssetMappingStatusSourceResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
