...
// checks if the CatalogV1alpha1ConsumerStageVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ConsumerStageVisibility{}

// CatalogV1alpha1ConsumerStageVisibility Definition of ConsumerStageVisibility for version v1alpha1 in group catalog.    Resource representing Stage visibility settings in the Marketplace for Consumer Organizations.
type CatalogV1alpha1ConsumerStageVisibility struct {
	...
	// Resource of kind ConsumerStageVisibility. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ConsumerStageVisibility. ConsumerStageVisibility name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ConsumerStageVisibility.
	...
	Spec CatalogV1alpha1ConsumerStageVisibilitySpec `json:"spec"`
...
type _CatalogV1alpha1ConsumerStageVisibility CatalogV1alpha1ConsumerStageVisibility
...
func NewCatalogV1alpha1ConsumerStageVisibility(spec CatalogV1alpha1ConsumerStageVisibilitySpec) *CatalogV1alpha1ConsumerStageVisibility {
	this := CatalogV1alpha1ConsumerStageVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ConsumerStageVisibility) GetSpec() CatalogV1alpha1ConsumerStageVisibilitySpec {
	if o == nil {
		var ret CatalogV1alpha1ConsumerStageVisibilitySpec
		return ret
	}
...
func (o CatalogV1alpha1ConsumerStageVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ConsumerStageVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ConsumerStageVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ConsumerStageVisibility := _CatalogV1alpha1ConsumerStageVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ConsumerStageVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ConsumerStageVisibility(varCatalogV1alpha1ConsumerStageVisibility)

	return err
}

type NullableCatalogV1alpha1ConsumerStageVisibility struct {
	value *CatalogV1alpha1ConsumerStageVisibility
	isSet bool
}

func (v NullableCatalogV1alpha1ConsumerStageVisibility) Get() *CatalogV1alpha1ConsumerStageVisibility {
	return v.value
}

func (v *NullableCatalogV1alpha1ConsumerStageVisibility) Set(val *CatalogV1alpha1ConsumerStageVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ConsumerStageVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ConsumerStageVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ConsumerStageVisibility(val *CatalogV1alpha1ConsumerStageVisibility) *NullableCatalogV1alpha1ConsumerStageVisibility {
	return &NullableCatalogV1alpha1ConsumerStageVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ConsumerStageVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ConsumerStageVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
