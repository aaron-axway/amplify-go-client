...
// checks if the ManagementV1alpha1ResourceHook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1ResourceHook{}

// ManagementV1alpha1ResourceHook Definition of ResourceHook for version v1alpha1 in group management.    Listen to API Server resource lifecycle changes.
type ManagementV1alpha1ResourceHook struct {
	...
	// Resource of kind ResourceHook. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ResourceHook. ResourceHook name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ResourceHook.
	...
	Spec ManagementV1alpha1ResourceHookSpec `json:"spec"`
...
type _ManagementV1alpha1ResourceHook ManagementV1alpha1ResourceHook
...
func NewManagementV1alpha1ResourceHook(spec ManagementV1alpha1ResourceHookSpec) *ManagementV1alpha1ResourceHook {
	this := ManagementV1alpha1ResourceHook{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1ResourceHook) GetSpec() ManagementV1alpha1ResourceHookSpec {
	if o == nil {
		var ret ManagementV1alpha1ResourceHookSpec
		return ret
	}
...
func (o ManagementV1alpha1ResourceHook) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1ResourceHook) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1ResourceHook) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1ResourceHook := _ManagementV1alpha1ResourceHook{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1ResourceHook)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1ResourceHook(varManagementV1alpha1ResourceHook)

	return err
}

type NullableManagementV1alpha1ResourceHook struct {
	value *ManagementV1alpha1ResourceHook
	isSet bool
}

func (v NullableManagementV1alpha1ResourceHook) Get() *ManagementV1alpha1ResourceHook {
	return v.value
}

func (v *NullableManagementV1alpha1ResourceHook) Set(val *ManagementV1alpha1ResourceHook) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1ResourceHook) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1ResourceHook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1ResourceHook(val *ManagementV1alpha1ResourceHook) *NullableManagementV1alpha1ResourceHook {
	return &NullableManagementV1alpha1ResourceHook{value: val, isSet: true}
}

func (v NullableManagementV1alpha1ResourceHook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1ResourceHook) UnmarshalJSON(src []byte) error {
	v.isSet = true
