...
// checks if the ManagementV1alpha1CredentialRequestDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1CredentialRequestDefinition{}

// ManagementV1alpha1CredentialRequestDefinition Definition of CredentialRequestDefinition for version v1alpha1 in group management.    Defines the supported credentials.
type ManagementV1alpha1CredentialRequestDefinition struct {
	...
	Spec ManagementV1alpha1CredentialRequestDefinitionSpec `json:"spec"`
	References *ManagementV1alpha1CredentialRequestDefinitionReferences `json:"references,omitempty"`
...
type _ManagementV1alpha1CredentialRequestDefinition ManagementV1alpha1CredentialRequestDefinition
...
func NewManagementV1alpha1CredentialRequestDefinition(spec ManagementV1alpha1CredentialRequestDefinitionSpec) *ManagementV1alpha1CredentialRequestDefinition {
	this := ManagementV1alpha1CredentialRequestDefinition{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1CredentialRequestDefinition) GetSpec() ManagementV1alpha1CredentialRequestDefinitionSpec {
	if o == nil {
		var ret ManagementV1alpha1CredentialRequestDefinitionSpec
		return ret
	}
...
func (o *ManagementV1alpha1CredentialRequestDefinition) GetReferences() ManagementV1alpha1CredentialRequestDefinitionReferences {
	if o == nil || IsNil(o.References) {
		var ret ManagementV1alpha1CredentialRequestDefinitionReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given ManagementV1alpha1CredentialRequestDefinitionReferences and assigns it to the References field.
...
func (o ManagementV1alpha1CredentialRequestDefinition) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1CredentialRequestDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1CredentialRequestDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1CredentialRequestDefinition := _ManagementV1alpha1CredentialRequestDefinition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1CredentialRequestDefinition)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1CredentialRequestDefinition(varManagementV1alpha1CredentialRequestDefinition)

	return err
}

type NullableManagementV1alpha1CredentialRequestDefinition struct {
	value *ManagementV1alpha1CredentialRequestDefinition
	isSet bool
}

func (v NullableManagementV1alpha1CredentialRequestDefinition) Get() *ManagementV1alpha1CredentialRequestDefinition {
	return v.value
}

func (v *NullableManagementV1alpha1CredentialRequestDefinition) Set(val *ManagementV1alpha1CredentialRequestDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1CredentialRequestDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1CredentialRequestDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1CredentialRequestDefinition(val *ManagementV1alpha1CredentialRequestDefinition) *NullableManagementV1alpha1CredentialRequestDefinition {
	return &NullableManagementV1alpha1CredentialRequestDefinition{value: val, isSet: true}
}

func (v NullableManagementV1alpha1CredentialRequestDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1CredentialRequestDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
