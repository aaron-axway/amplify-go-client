...
// checks if the ManagementV1alpha1MeshWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1MeshWorkload{}

// ManagementV1alpha1MeshWorkload Definition of MeshWorkload for version v1alpha1 in group management.    A MeshWorkload retains useful information from one or a group of pods managed by the same k8s workload.
type ManagementV1alpha1MeshWorkload struct {
	...
	// Resource of kind MeshWorkload. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the MeshWorkload. MeshWorkload name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the MeshWorkload.
	...
	Spec ManagementV1alpha1MeshWorkloadSpec `json:"spec"`
...
type _ManagementV1alpha1MeshWorkload ManagementV1alpha1MeshWorkload
...
func NewManagementV1alpha1MeshWorkload(spec ManagementV1alpha1MeshWorkloadSpec) *ManagementV1alpha1MeshWorkload {
	this := ManagementV1alpha1MeshWorkload{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1MeshWorkload) GetSpec() ManagementV1alpha1MeshWorkloadSpec {
	if o == nil {
		var ret ManagementV1alpha1MeshWorkloadSpec
		return ret
	}
...
func (o ManagementV1alpha1MeshWorkload) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1MeshWorkload) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1MeshWorkload) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1MeshWorkload := _ManagementV1alpha1MeshWorkload{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1MeshWorkload)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1MeshWorkload(varManagementV1alpha1MeshWorkload)

	return err
}

type NullableManagementV1alpha1MeshWorkload struct {
	value *ManagementV1alpha1MeshWorkload
	isSet bool
}

func (v NullableManagementV1alpha1MeshWorkload) Get() *ManagementV1alpha1MeshWorkload {
	return v.value
}

func (v *NullableManagementV1alpha1MeshWorkload) Set(val *ManagementV1alpha1MeshWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1MeshWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1MeshWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1MeshWorkload(val *ManagementV1alpha1MeshWorkload) *NullableManagementV1alpha1MeshWorkload {
	return &NullableManagementV1alpha1MeshWorkload{value: val, isSet: true}
}

func (v NullableManagementV1alpha1MeshWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1MeshWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
