...
// checks if the CatalogV1alpha1Resource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Resource{}

// CatalogV1alpha1Resource Definition of Resource for version v1alpha1 in group catalog.    Resource representing a Product resource
type CatalogV1alpha1Resource struct {
	...
	Spec CatalogV1alpha1ResourceSpec `json:"spec"`
...
type _CatalogV1alpha1Resource CatalogV1alpha1Resource
...
func (o *CatalogV1alpha1Resource) GetSpec() CatalogV1alpha1ResourceSpec {
	if o == nil {
		var ret CatalogV1alpha1ResourceSpec
		return ret
	}
...
func (o CatalogV1alpha1Resource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Resource) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Resource) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Resource := _CatalogV1alpha1Resource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Resource)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Resource(varCatalogV1alpha1Resource)

	return err
}

type NullableCatalogV1alpha1Resource struct {
	value *CatalogV1alpha1Resource
	isSet bool
}

func (v NullableCatalogV1alpha1Resource) Get() *CatalogV1alpha1Resource {
	return v.value
}

func (v *NullableCatalogV1alpha1Resource) Set(val *CatalogV1alpha1Resource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Resource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Resource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Resource(val *CatalogV1alpha1Resource) *NullableCatalogV1alpha1Resource {
	return &NullableCatalogV1alpha1Resource{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Resource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Resource) UnmarshalJSON(src []byte) error {
	v.isSet = true
