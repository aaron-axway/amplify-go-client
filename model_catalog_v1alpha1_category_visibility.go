...
// checks if the CatalogV1alpha1CategoryVisibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1CategoryVisibility{}

// CatalogV1alpha1CategoryVisibility Definition of CategoryVisibility for version v1alpha1 in group catalog.    Resource representing a Category visibility settings in the Marketplace.
type CatalogV1alpha1CategoryVisibility struct {
	...
	// Resource of kind CategoryVisibility. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the CategoryVisibility. CategoryVisibility name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the CategoryVisibility.
	...
	Spec CatalogV1alpha1CategoryVisibilitySpec `json:"spec"`
...
type _CatalogV1alpha1CategoryVisibility CatalogV1alpha1CategoryVisibility
...
func NewCatalogV1alpha1CategoryVisibility(spec CatalogV1alpha1CategoryVisibilitySpec) *CatalogV1alpha1CategoryVisibility {
	this := CatalogV1alpha1CategoryVisibility{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1CategoryVisibility) GetSpec() CatalogV1alpha1CategoryVisibilitySpec {
	if o == nil {
		var ret CatalogV1alpha1CategoryVisibilitySpec
		return ret
	}
...
func (o CatalogV1alpha1CategoryVisibility) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1CategoryVisibility) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1CategoryVisibility) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1CategoryVisibility := _CatalogV1alpha1CategoryVisibility{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1CategoryVisibility)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1CategoryVisibility(varCatalogV1alpha1CategoryVisibility)

	return err
}

type NullableCatalogV1alpha1CategoryVisibility struct {
	value *CatalogV1alpha1CategoryVisibility
	isSet bool
}

func (v NullableCatalogV1alpha1CategoryVisibility) Get() *CatalogV1alpha1CategoryVisibility {
	return v.value
}

func (v *NullableCatalogV1alpha1CategoryVisibility) Set(val *CatalogV1alpha1CategoryVisibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1CategoryVisibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1CategoryVisibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1CategoryVisibility(val *CatalogV1alpha1CategoryVisibility) *NullableCatalogV1alpha1CategoryVisibility {
	return &NullableCatalogV1alpha1CategoryVisibility{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1CategoryVisibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1CategoryVisibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
