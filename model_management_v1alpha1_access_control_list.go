...
// checks if the ManagementV1alpha1AccessControlList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AccessControlList{}

// ManagementV1alpha1AccessControlList Definition of AccessControlList for version v1alpha1 in group management.    Resource that grants access to resource(s) to the specified subject(s)
type ManagementV1alpha1AccessControlList struct {
	...
	// Resource of kind AccessControlList. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the AccessControlList. AccessControlList name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the AccessControlList.
	...
	Spec ManagementV1alpha1AccessControlListSpec `json:"spec"`
...
type _ManagementV1alpha1AccessControlList ManagementV1alpha1AccessControlList
...
func NewManagementV1alpha1AccessControlList(spec ManagementV1alpha1AccessControlListSpec) *ManagementV1alpha1AccessControlList {
	this := ManagementV1alpha1AccessControlList{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1AccessControlList) GetSpec() ManagementV1alpha1AccessControlListSpec {
	if o == nil {
		var ret ManagementV1alpha1AccessControlListSpec
		return ret
	}
...
func (o ManagementV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AccessControlList) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1AccessControlList) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1AccessControlList := _ManagementV1alpha1AccessControlList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1AccessControlList)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1AccessControlList(varManagementV1alpha1AccessControlList)

	return err
}

type NullableManagementV1alpha1AccessControlList struct {
	value *ManagementV1alpha1AccessControlList
	isSet bool
}

func (v NullableManagementV1alpha1AccessControlList) Get() *ManagementV1alpha1AccessControlList {
	return v.value
}

func (v *NullableManagementV1alpha1AccessControlList) Set(val *ManagementV1alpha1AccessControlList) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AccessControlList) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AccessControlList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AccessControlList(val *ManagementV1alpha1AccessControlList) *NullableManagementV1alpha1AccessControlList {
	return &NullableManagementV1alpha1AccessControlList{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AccessControlList) UnmarshalJSON(src []byte) error {
	v.isSet = true
