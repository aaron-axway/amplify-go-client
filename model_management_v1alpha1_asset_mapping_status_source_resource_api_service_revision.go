...
// checks if the ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision{}

// ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision struct for ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision
type ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision struct {
...
func NewManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision() *ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision {
	this := ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision{}
	return &this
}
...
func (o ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) ToMap() (map[string]interface{}, error) {
...
type NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision struct {
	value *ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision
	isSet bool
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) Get() *ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision {
	return v.value
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) Set(val *ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision(val *ManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision {
	return &NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiServiceRevision) UnmarshalJSON(src []byte) error {
	v.isSet = true
