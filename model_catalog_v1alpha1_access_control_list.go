...
// checks if the CatalogV1alpha1AccessControlList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AccessControlList{}

// CatalogV1alpha1AccessControlList Definition of AccessControlList for version v1alpha1 in group catalog.    Resource that grants access to resource(s) to the specified subject(s)
type CatalogV1alpha1AccessControlList struct {
	...
	Spec CatalogV1alpha1AccessControlListSpec `json:"spec"`
...
type _CatalogV1alpha1AccessControlList CatalogV1alpha1AccessControlList
...
func NewCatalogV1alpha1AccessControlList(spec CatalogV1alpha1AccessControlListSpec) *CatalogV1alpha1AccessControlList {
	this := CatalogV1alpha1AccessControlList{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1AccessControlList) GetSpec() CatalogV1alpha1AccessControlListSpec {
	if o == nil {
		var ret CatalogV1alpha1AccessControlListSpec
		return ret
	}
...
func (o CatalogV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AccessControlList) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AccessControlList) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AccessControlList := _CatalogV1alpha1AccessControlList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AccessControlList)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AccessControlList(varCatalogV1alpha1AccessControlList)

	return err
}

type NullableCatalogV1alpha1AccessControlList struct {
	value *CatalogV1alpha1AccessControlList
	isSet bool
}

func (v NullableCatalogV1alpha1AccessControlList) Get() *CatalogV1alpha1AccessControlList {
	return v.value
}

func (v *NullableCatalogV1alpha1AccessControlList) Set(val *CatalogV1alpha1AccessControlList) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AccessControlList) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AccessControlList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AccessControlList(val *CatalogV1alpha1AccessControlList) *NullableCatalogV1alpha1AccessControlList {
	return &NullableCatalogV1alpha1AccessControlList{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AccessControlList) UnmarshalJSON(src []byte) error {
	v.isSet = true
