...
// checks if the ManagementV1alpha1AssetMappingStatusSourceResourceApiService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1AssetMappingStatusSourceResourceApiService{}

// ManagementV1alpha1AssetMappingStatusSourceResourceApiService struct for ManagementV1alpha1AssetMappingStatusSourceResourceApiService
type ManagementV1alpha1AssetMappingStatusSourceResourceApiService struct {
...
func NewManagementV1alpha1AssetMappingStatusSourceResourceApiService() *ManagementV1alpha1AssetMappingStatusSourceResourceApiService {
	this := ManagementV1alpha1AssetMappingStatusSourceResourceApiService{}
	return &this
}
...
func (o ManagementV1alpha1AssetMappingStatusSourceResourceApiService) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1AssetMappingStatusSourceResourceApiService) ToMap() (map[string]interface{}, error) {
...
type NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService struct {
	value *ManagementV1alpha1AssetMappingStatusSourceResourceApiService
	isSet bool
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) Get() *ManagementV1alpha1AssetMappingStatusSourceResourceApiService {
	return v.value
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) Set(val *ManagementV1alpha1AssetMappingStatusSourceResourceApiService) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1AssetMappingStatusSourceResourceApiService(val *ManagementV1alpha1AssetMappingStatusSourceResourceApiService) *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService {
	return &NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService{value: val, isSet: true}
}

func (v NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1AssetMappingStatusSourceResourceApiService) UnmarshalJSON(src []byte) error {
	v.isSet = true
