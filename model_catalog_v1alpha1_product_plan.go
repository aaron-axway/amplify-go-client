...
// checks if the CatalogV1alpha1ProductPlan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1ProductPlan{}

// CatalogV1alpha1ProductPlan Definition of ProductPlan for version v1alpha1 in group catalog.    Resource representing an Amplify Central Product Plan.
type CatalogV1alpha1ProductPlan struct {
	...
	// Resource of kind ProductPlan. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ProductPlan. ProductPlan name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ProductPlan.
	...
	Spec CatalogV1alpha1ProductPlanSpec `json:"spec"`
	State *CatalogV1alpha1ProductPlanState `json:"state,omitempty"`
	References *CatalogV1alpha1ProductPlanReferences `json:"references,omitempty"`
	Status *CatalogV1alpha1ProductPlanStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1ProductPlan CatalogV1alpha1ProductPlan
...
func NewCatalogV1alpha1ProductPlan(spec CatalogV1alpha1ProductPlanSpec) *CatalogV1alpha1ProductPlan {
	this := CatalogV1alpha1ProductPlan{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1ProductPlan) GetSpec() CatalogV1alpha1ProductPlanSpec {
	if o == nil {
		var ret CatalogV1alpha1ProductPlanSpec
		return ret
	}
...
func (o *CatalogV1alpha1ProductPlan) GetState() CatalogV1alpha1ProductPlanState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1alpha1ProductPlanState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1alpha1ProductPlanState and assigns it to the State field.
...
func (o *CatalogV1alpha1ProductPlan) GetReferences() CatalogV1alpha1ProductPlanReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1alpha1ProductPlanReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1alpha1ProductPlanReferences and assigns it to the References field.
...
func (o *CatalogV1alpha1ProductPlan) GetStatus() CatalogV1alpha1ProductPlanStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1ProductPlanStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1ProductPlanStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1ProductPlan) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1ProductPlan) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1ProductPlan) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1ProductPlan := _CatalogV1alpha1ProductPlan{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1ProductPlan)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1ProductPlan(varCatalogV1alpha1ProductPlan)

	return err
}

type NullableCatalogV1alpha1ProductPlan struct {
	value *CatalogV1alpha1ProductPlan
	isSet bool
}

func (v NullableCatalogV1alpha1ProductPlan) Get() *CatalogV1alpha1ProductPlan {
	return v.value
}

func (v *NullableCatalogV1alpha1ProductPlan) Set(val *CatalogV1alpha1ProductPlan) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1ProductPlan) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1ProductPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1ProductPlan(val *CatalogV1alpha1ProductPlan) *NullableCatalogV1alpha1ProductPlan {
	return &NullableCatalogV1alpha1ProductPlan{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1ProductPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1ProductPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
