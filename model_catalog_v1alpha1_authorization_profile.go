...
// checks if the CatalogV1alpha1AuthorizationProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1AuthorizationProfile{}

// CatalogV1alpha1AuthorizationProfile Definition of AuthorizationProfile for version v1alpha1 in group catalog.    Defines a group of Asset and Credential RequestDefinitions that can be used to access an AssetResource.
type CatalogV1alpha1AuthorizationProfile struct {
	...
	// Resource of kind AuthorizationProfile. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the AuthorizationProfile. AuthorizationProfile name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the AuthorizationProfile.
	...
	Spec CatalogV1alpha1AuthorizationProfileSpec `json:"spec"`
	References *CatalogV1alpha1AuthorizationProfileReferences `json:"references,omitempty"`
	Policies *CatalogV1alpha1AuthorizationProfilePolicies `json:"policies,omitempty"`
...
type _CatalogV1alpha1AuthorizationProfile CatalogV1alpha1AuthorizationProfile
...
func NewCatalogV1alpha1AuthorizationProfile(spec CatalogV1alpha1AuthorizationProfileSpec) *CatalogV1alpha1AuthorizationProfile {
	this := CatalogV1alpha1AuthorizationProfile{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1alpha1AuthorizationProfile) GetSpec() CatalogV1alpha1AuthorizationProfileSpec {
	if o == nil {
		var ret CatalogV1alpha1AuthorizationProfileSpec
		return ret
	}
...
func (o *CatalogV1alpha1AuthorizationProfile) GetReferences() CatalogV1alpha1AuthorizationProfileReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1alpha1AuthorizationProfileReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1alpha1AuthorizationProfileReferences and assigns it to the References field.
...
func (o *CatalogV1alpha1AuthorizationProfile) GetPolicies() CatalogV1alpha1AuthorizationProfilePolicies {
	if o == nil || IsNil(o.Policies) {
		var ret CatalogV1alpha1AuthorizationProfilePolicies
		return ret
	}
	return *o.Policies
}
...
// SetPolicies gets a reference to the given CatalogV1alpha1AuthorizationProfilePolicies and assigns it to the Policies field.
...
func (o CatalogV1alpha1AuthorizationProfile) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1AuthorizationProfile) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1AuthorizationProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1AuthorizationProfile := _CatalogV1alpha1AuthorizationProfile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1AuthorizationProfile)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1AuthorizationProfile(varCatalogV1alpha1AuthorizationProfile)

	return err
}

type NullableCatalogV1alpha1AuthorizationProfile struct {
	value *CatalogV1alpha1AuthorizationProfile
	isSet bool
}

func (v NullableCatalogV1alpha1AuthorizationProfile) Get() *CatalogV1alpha1AuthorizationProfile {
	return v.value
}

func (v *NullableCatalogV1alpha1AuthorizationProfile) Set(val *CatalogV1alpha1AuthorizationProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1AuthorizationProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1AuthorizationProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1AuthorizationProfile(val *CatalogV1alpha1AuthorizationProfile) *NullableCatalogV1alpha1AuthorizationProfile {
	return &NullableCatalogV1alpha1AuthorizationProfile{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1AuthorizationProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1AuthorizationProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
