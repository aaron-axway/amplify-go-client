...
// checks if the DefinitionsV1alpha1CommandLineInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefinitionsV1alpha1CommandLineInterface{}

// DefinitionsV1alpha1CommandLineInterface Definition of CommandLineInterface for version v1alpha1 in group definitions.    Resource representing the command line properties for a resource definition in the group.
type DefinitionsV1alpha1CommandLineInterface struct {
	...
	// Name of the CommandLineInterface. CommandLineInterface name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
...
type _DefinitionsV1alpha1CommandLineInterface DefinitionsV1alpha1CommandLineInterface
...
func NewDefinitionsV1alpha1CommandLineInterface(spec DefinitionsV1alpha1CommandLineInterfaceSpec) *DefinitionsV1alpha1CommandLineInterface {
	this := DefinitionsV1alpha1CommandLineInterface{}
	this.Spec = spec
	return &this
}
...
func (o *DefinitionsV1alpha1CommandLineInterface) GetSpec() DefinitionsV1alpha1CommandLineInterfaceSpec {
	if o == nil {
		var ret DefinitionsV1alpha1CommandLineInterfaceSpec
		return ret
	}
...
func (o DefinitionsV1alpha1CommandLineInterface) MarshalJSON() ([]byte, error) {
...
func (o DefinitionsV1alpha1CommandLineInterface) ToMap() (map[string]interface{}, error) {
...
func (o *DefinitionsV1alpha1CommandLineInterface) UnmarshalJSON(data []byte) (err error) {
	...
	varDefinitionsV1alpha1CommandLineInterface := _DefinitionsV1alpha1CommandLineInterface{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDefinitionsV1alpha1CommandLineInterface)

	if err != nil {
		return err
	}

	*o = DefinitionsV1alpha1CommandLineInterface(varDefinitionsV1alpha1CommandLineInterface)

	return err
}

type NullableDefinitionsV1alpha1CommandLineInterface struct {
	value *DefinitionsV1alpha1CommandLineInterface
	isSet bool
}

func (v NullableDefinitionsV1alpha1CommandLineInterface) Get() *DefinitionsV1alpha1CommandLineInterface {
	return v.value
}

func (v *NullableDefinitionsV1alpha1CommandLineInterface) Set(val *DefinitionsV1alpha1CommandLineInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableDefinitionsV1alpha1CommandLineInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableDefinitionsV1alpha1CommandLineInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefinitionsV1alpha1CommandLineInterface(val *DefinitionsV1alpha1CommandLineInterface) *NullableDefinitionsV1alpha1CommandLineInterface {
	return &NullableDefinitionsV1alpha1CommandLineInterface{value: val, isSet: true}
}

func (v NullableDefinitionsV1alpha1CommandLineInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefinitionsV1alpha1CommandLineInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
