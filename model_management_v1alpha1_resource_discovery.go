...
// checks if the ManagementV1alpha1ResourceDiscovery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1ResourceDiscovery{}

// ManagementV1alpha1ResourceDiscovery Definition of ResourceDiscovery for version v1alpha1 in group management.    Resource controlling resource discoveries in a mesh.
type ManagementV1alpha1ResourceDiscovery struct {
	...
	// Resource of kind ResourceDiscovery. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the ResourceDiscovery. ResourceDiscovery name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the ResourceDiscovery.
	...
	Spec ManagementV1alpha1ResourceDiscoverySpec `json:"spec"`
...
type _ManagementV1alpha1ResourceDiscovery ManagementV1alpha1ResourceDiscovery
...
func NewManagementV1alpha1ResourceDiscovery(spec ManagementV1alpha1ResourceDiscoverySpec) *ManagementV1alpha1ResourceDiscovery {
	this := ManagementV1alpha1ResourceDiscovery{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1ResourceDiscovery) GetSpec() ManagementV1alpha1ResourceDiscoverySpec {
	if o == nil {
		var ret ManagementV1alpha1ResourceDiscoverySpec
		return ret
	}
...
func (o ManagementV1alpha1ResourceDiscovery) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1ResourceDiscovery) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1ResourceDiscovery) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1ResourceDiscovery := _ManagementV1alpha1ResourceDiscovery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1ResourceDiscovery)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1ResourceDiscovery(varManagementV1alpha1ResourceDiscovery)

	return err
}

type NullableManagementV1alpha1ResourceDiscovery struct {
	value *ManagementV1alpha1ResourceDiscovery
	isSet bool
}

func (v NullableManagementV1alpha1ResourceDiscovery) Get() *ManagementV1alpha1ResourceDiscovery {
	return v.value
}

func (v *NullableManagementV1alpha1ResourceDiscovery) Set(val *ManagementV1alpha1ResourceDiscovery) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1ResourceDiscovery) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1ResourceDiscovery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1ResourceDiscovery(val *ManagementV1alpha1ResourceDiscovery) *NullableManagementV1alpha1ResourceDiscovery {
	return &NullableManagementV1alpha1ResourceDiscovery{value: val, isSet: true}
}

func (v NullableManagementV1alpha1ResourceDiscovery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1ResourceDiscovery) UnmarshalJSON(src []byte) error {
	v.isSet = true
