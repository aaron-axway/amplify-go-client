...
// checks if the ManagementV1alpha1TraceabilityAgent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1TraceabilityAgent{}

// ManagementV1alpha1TraceabilityAgent Definition of TraceabilityAgent for version v1alpha1 in group management.    Resource representing a traceability agent
type ManagementV1alpha1TraceabilityAgent struct {
	...
	// Resource of kind TraceabilityAgent. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the TraceabilityAgent. TraceabilityAgent name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the TraceabilityAgent.
	...
	Spec ManagementV1alpha1TraceabilityAgentSpec `json:"spec"`
	Status *ManagementV1alpha1TraceabilityAgentStatus `json:"status,omitempty"`
	Dataplane *ManagementV1alpha1TraceabilityAgentDataplane `json:"dataplane,omitempty"`
...
type _ManagementV1alpha1TraceabilityAgent ManagementV1alpha1TraceabilityAgent
...
func NewManagementV1alpha1TraceabilityAgent(spec ManagementV1alpha1TraceabilityAgentSpec) *ManagementV1alpha1TraceabilityAgent {
	this := ManagementV1alpha1TraceabilityAgent{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1TraceabilityAgent) GetSpec() ManagementV1alpha1TraceabilityAgentSpec {
	if o == nil {
		var ret ManagementV1alpha1TraceabilityAgentSpec
		return ret
	}
...
func (o *ManagementV1alpha1TraceabilityAgent) GetStatus() ManagementV1alpha1TraceabilityAgentStatus {
	if o == nil || IsNil(o.Status) {
		var ret ManagementV1alpha1TraceabilityAgentStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ManagementV1alpha1TraceabilityAgentStatus and assigns it to the Status field.
...
func (o *ManagementV1alpha1TraceabilityAgent) GetDataplane() ManagementV1alpha1TraceabilityAgentDataplane {
	if o == nil || IsNil(o.Dataplane) {
		var ret ManagementV1alpha1TraceabilityAgentDataplane
		return ret
	}
	return *o.Dataplane
}
...
// SetDataplane gets a reference to the given ManagementV1alpha1TraceabilityAgentDataplane and assigns it to the Dataplane field.
...
func (o ManagementV1alpha1TraceabilityAgent) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1TraceabilityAgent) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1TraceabilityAgent) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1TraceabilityAgent := _ManagementV1alpha1TraceabilityAgent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1TraceabilityAgent)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1TraceabilityAgent(varManagementV1alpha1TraceabilityAgent)

	return err
}

type NullableManagementV1alpha1TraceabilityAgent struct {
	value *ManagementV1alpha1TraceabilityAgent
	isSet bool
}

func (v NullableManagementV1alpha1TraceabilityAgent) Get() *ManagementV1alpha1TraceabilityAgent {
	return v.value
}

func (v *NullableManagementV1alpha1TraceabilityAgent) Set(val *ManagementV1alpha1TraceabilityAgent) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1TraceabilityAgent) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1TraceabilityAgent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1TraceabilityAgent(val *ManagementV1alpha1TraceabilityAgent) *NullableManagementV1alpha1TraceabilityAgent {
	return &NullableManagementV1alpha1TraceabilityAgent{value: val, isSet: true}
}

func (v NullableManagementV1alpha1TraceabilityAgent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1TraceabilityAgent) UnmarshalJSON(src []byte) error {
	v.isSet = true
