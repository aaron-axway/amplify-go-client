...
// checks if the ManagementV1alpha1APISpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1APISpec{}

// ManagementV1alpha1APISpec Definition of APISpec for version v1alpha1 in group management.    An API Spec
type ManagementV1alpha1APISpec struct {
	...
	// Resource of kind APISpec. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the APISpec. APISpec name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the APISpec.
	...
	Spec ManagementV1alpha1APISpecSpec `json:"spec"`
...
type _ManagementV1alpha1APISpec ManagementV1alpha1APISpec
...
func NewManagementV1alpha1APISpec(spec ManagementV1alpha1APISpecSpec) *ManagementV1alpha1APISpec {
	this := ManagementV1alpha1APISpec{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1APISpec) GetSpec() ManagementV1alpha1APISpecSpec {
	if o == nil {
		var ret ManagementV1alpha1APISpecSpec
		return ret
	}
...
func (o ManagementV1alpha1APISpec) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1APISpec) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1APISpec) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1APISpec := _ManagementV1alpha1APISpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1APISpec)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1APISpec(varManagementV1alpha1APISpec)

	return err
}

type NullableManagementV1alpha1APISpec struct {
	value *ManagementV1alpha1APISpec
	isSet bool
}

func (v NullableManagementV1alpha1APISpec) Get() *ManagementV1alpha1APISpec {
	return v.value
}

func (v *NullableManagementV1alpha1APISpec) Set(val *ManagementV1alpha1APISpec) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1APISpec) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1APISpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1APISpec(val *ManagementV1alpha1APISpec) *NullableManagementV1alpha1APISpec {
	return &NullableManagementV1alpha1APISpec{value: val, isSet: true}
}

func (v NullableManagementV1alpha1APISpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1APISpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
