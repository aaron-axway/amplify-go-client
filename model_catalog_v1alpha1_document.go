...
// checks if the CatalogV1alpha1Document type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1alpha1Document{}

// CatalogV1alpha1Document Definition of Document for version v1alpha1 in group catalog.    Resource representing Document
type CatalogV1alpha1Document struct {
	...
	// Resource of kind Document. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the Document. Document name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	...
	Spec CatalogV1alpha1DocumentSpec `json:"spec"`
	// Image for the Document expressed as a Data-Uri (https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs)
	Icon *string `json:"icon,omitempty" validate:"regexp=^data:((?:\\\\w+\\/(?:(?!;).)+)?)((?:;[\\\\w\\\\W]*?[^;])*),(.+)$"`
	Status *CatalogV1alpha1DocumentStatus `json:"status,omitempty"`
...
type _CatalogV1alpha1Document CatalogV1alpha1Document
...
func (o *CatalogV1alpha1Document) GetSpec() CatalogV1alpha1DocumentSpec {
	if o == nil {
		var ret CatalogV1alpha1DocumentSpec
		return ret
	}
...
func (o *CatalogV1alpha1Document) GetStatus() CatalogV1alpha1DocumentStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1alpha1DocumentStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1alpha1DocumentStatus and assigns it to the Status field.
...
func (o CatalogV1alpha1Document) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1alpha1Document) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1alpha1Document) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1alpha1Document := _CatalogV1alpha1Document{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1alpha1Document)

	if err != nil {
		return err
	}

	*o = CatalogV1alpha1Document(varCatalogV1alpha1Document)

	return err
}

type NullableCatalogV1alpha1Document struct {
	value *CatalogV1alpha1Document
	isSet bool
}

func (v NullableCatalogV1alpha1Document) Get() *CatalogV1alpha1Document {
	return v.value
}

func (v *NullableCatalogV1alpha1Document) Set(val *CatalogV1alpha1Document) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1alpha1Document) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1alpha1Document) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1alpha1Document(val *CatalogV1alpha1Document) *NullableCatalogV1alpha1Document {
	return &NullableCatalogV1alpha1Document{value: val, isSet: true}
}

func (v NullableCatalogV1alpha1Document) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1alpha1Document) UnmarshalJSON(src []byte) error {
	v.isSet = true
