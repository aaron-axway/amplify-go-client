...
// checks if the CatalogV1DocumentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1DocumentResource{}

// CatalogV1DocumentResource Definition of DocumentResource for version v1 in group catalog.    Resource representing a global document resource
type CatalogV1DocumentResource struct {
	...
	Spec CatalogV1DocumentResourceSpec `json:"spec"`
	...
	State *CatalogV1DocumentResourceState `json:"state,omitempty"`
	References *CatalogV1DocumentResourceReferences `json:"references,omitempty"`
...
type _CatalogV1DocumentResource CatalogV1DocumentResource
...
func NewCatalogV1DocumentResource(spec CatalogV1DocumentResourceSpec) *CatalogV1DocumentResource {
	this := CatalogV1DocumentResource{}
	this.Spec = spec
	return &this
}
...
func (o *CatalogV1DocumentResource) GetSpec() CatalogV1DocumentResourceSpec {
	if o == nil {
		var ret CatalogV1DocumentResourceSpec
		return ret
	}
...
func (o *CatalogV1DocumentResource) GetState() CatalogV1DocumentResourceState {
	if o == nil || IsNil(o.State) {
		var ret CatalogV1DocumentResourceState
		return ret
	}
	return *o.State
}
...
// SetState gets a reference to the given CatalogV1DocumentResourceState and assigns it to the State field.
...
func (o *CatalogV1DocumentResource) GetReferences() CatalogV1DocumentResourceReferences {
	if o == nil || IsNil(o.References) {
		var ret CatalogV1DocumentResourceReferences
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CatalogV1DocumentResourceReferences and assigns it to the References field.
...
func (o CatalogV1DocumentResource) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1DocumentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1DocumentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1DocumentResource := _CatalogV1DocumentResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1DocumentResource)

	if err != nil {
		return err
	}

	*o = CatalogV1DocumentResource(varCatalogV1DocumentResource)

	return err
}

type NullableCatalogV1DocumentResource struct {
	value *CatalogV1DocumentResource
	isSet bool
}

func (v NullableCatalogV1DocumentResource) Get() *CatalogV1DocumentResource {
	return v.value
}

func (v *NullableCatalogV1DocumentResource) Set(val *CatalogV1DocumentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1DocumentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1DocumentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1DocumentResource(val *CatalogV1DocumentResource) *NullableCatalogV1DocumentResource {
	return &NullableCatalogV1DocumentResource{value: val, isSet: true}
}

func (v NullableCatalogV1DocumentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1DocumentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
