...
// checks if the ManagementV1alpha1K8SResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1K8SResource{}

// ManagementV1alpha1K8SResource Definition of K8SResource for version v1alpha1 in group management.    Represents a Kubernetes resource in a mesh.
type ManagementV1alpha1K8SResource struct {
	...
	// Resource of kind K8SResource. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the K8SResource. K8SResource name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the K8SResource.
	...
	Spec ManagementV1alpha1K8SResourceSpec `json:"spec"`
...
type _ManagementV1alpha1K8SResource ManagementV1alpha1K8SResource
...
func NewManagementV1alpha1K8SResource(spec ManagementV1alpha1K8SResourceSpec) *ManagementV1alpha1K8SResource {
	this := ManagementV1alpha1K8SResource{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1K8SResource) GetSpec() ManagementV1alpha1K8SResourceSpec {
	if o == nil {
		var ret ManagementV1alpha1K8SResourceSpec
		return ret
	}
...
func (o ManagementV1alpha1K8SResource) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1K8SResource) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1K8SResource) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1K8SResource := _ManagementV1alpha1K8SResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1K8SResource)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1K8SResource(varManagementV1alpha1K8SResource)

	return err
}

type NullableManagementV1alpha1K8SResource struct {
	value *ManagementV1alpha1K8SResource
	isSet bool
}

func (v NullableManagementV1alpha1K8SResource) Get() *ManagementV1alpha1K8SResource {
	return v.value
}

func (v *NullableManagementV1alpha1K8SResource) Set(val *ManagementV1alpha1K8SResource) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1K8SResource) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1K8SResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1K8SResource(val *ManagementV1alpha1K8SResource) *NullableManagementV1alpha1K8SResource {
	return &NullableManagementV1alpha1K8SResource{value: val, isSet: true}
}

func (v NullableManagementV1alpha1K8SResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1K8SResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
