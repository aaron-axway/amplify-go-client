...
// checks if the ManagementV1alpha1K8SCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementV1alpha1K8SCluster{}

// ManagementV1alpha1K8SCluster Definition of K8SCluster for version v1alpha1 in group management.    Resource representing a kubernetes cluster.
type ManagementV1alpha1K8SCluster struct {
	...
	// Resource of kind K8SCluster. Cannot be updated. The server infers this from the endpoint the client submits the request to.
	Kind *string `json:"kind,omitempty"`
	// Name of the K8SCluster. K8SCluster name is unique and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
	Name *string `json:"name,omitempty" validate:"regexp=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*"`
	// The friendly name of the K8SCluster.
	...
	Spec ManagementV1alpha1K8SClusterSpec `json:"spec"`
...
type _ManagementV1alpha1K8SCluster ManagementV1alpha1K8SCluster
...
func NewManagementV1alpha1K8SCluster(spec ManagementV1alpha1K8SClusterSpec) *ManagementV1alpha1K8SCluster {
	this := ManagementV1alpha1K8SCluster{}
	this.Spec = spec
	return &this
}
...
func (o *ManagementV1alpha1K8SCluster) GetSpec() ManagementV1alpha1K8SClusterSpec {
	if o == nil {
		var ret ManagementV1alpha1K8SClusterSpec
		return ret
	}
...
func (o ManagementV1alpha1K8SCluster) MarshalJSON() ([]byte, error) {
...
func (o ManagementV1alpha1K8SCluster) ToMap() (map[string]interface{}, error) {
...
func (o *ManagementV1alpha1K8SCluster) UnmarshalJSON(data []byte) (err error) {
	...
	varManagementV1alpha1K8SCluster := _ManagementV1alpha1K8SCluster{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagementV1alpha1K8SCluster)

	if err != nil {
		return err
	}

	*o = ManagementV1alpha1K8SCluster(varManagementV1alpha1K8SCluster)

	return err
}

type NullableManagementV1alpha1K8SCluster struct {
	value *ManagementV1alpha1K8SCluster
	isSet bool
}

func (v NullableManagementV1alpha1K8SCluster) Get() *ManagementV1alpha1K8SCluster {
	return v.value
}

func (v *NullableManagementV1alpha1K8SCluster) Set(val *ManagementV1alpha1K8SCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementV1alpha1K8SCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementV1alpha1K8SCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementV1alpha1K8SCluster(val *ManagementV1alpha1K8SCluster) *NullableManagementV1alpha1K8SCluster {
	return &NullableManagementV1alpha1K8SCluster{value: val, isSet: true}
}

func (v NullableManagementV1alpha1K8SCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementV1alpha1K8SCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
