...
// checks if the CatalogV1Document type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1Document{}

// CatalogV1Document Definition of Document for version v1 in group catalog.    Resource representing Document
type CatalogV1Document struct {
	...
	Spec CatalogV1DocumentSpec `json:"spec"`
	...
	Status *CatalogV1DocumentStatus `json:"status,omitempty"`
...
type _CatalogV1Document CatalogV1Document
...
func (o *CatalogV1Document) GetStatus() CatalogV1DocumentStatus {
	if o == nil || IsNil(o.Status) {
		var ret CatalogV1DocumentStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CatalogV1DocumentStatus and assigns it to the Status field.
...
func (o CatalogV1Document) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1Document) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogV1Document) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogV1Document := _CatalogV1Document{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogV1Document)

	if err != nil {
		return err
	}

	*o = CatalogV1Document(varCatalogV1Document)

	return err
}

type NullableCatalogV1Document struct {
	value *CatalogV1Document
	isSet bool
}

func (v NullableCatalogV1Document) Get() *CatalogV1Document {
	return v.value
}

func (v *NullableCatalogV1Document) Set(val *CatalogV1Document) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1Document) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1Document) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1Document(val *CatalogV1Document) *NullableCatalogV1Document {
	return &NullableCatalogV1Document{value: val, isSet: true}
}

func (v NullableCatalogV1Document) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1Document) UnmarshalJSON(src []byte) error {
	v.isSet = true
