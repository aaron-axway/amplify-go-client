...
// checks if the DefinitionsV1alpha1AccessControlList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefinitionsV1alpha1AccessControlList{}

// DefinitionsV1alpha1AccessControlList Definition of AccessControlList for version v1alpha1 in group definitions.    Resource that grants access to resource(s) to the specified subject(s)
type DefinitionsV1alpha1AccessControlList struct {
	...
	Spec DefinitionsV1alpha1AccessControlListSpec `json:"spec"`
...
type _DefinitionsV1alpha1AccessControlList DefinitionsV1alpha1AccessControlList
...
func NewDefinitionsV1alpha1AccessControlList(spec DefinitionsV1alpha1AccessControlListSpec) *DefinitionsV1alpha1AccessControlList {
	this := DefinitionsV1alpha1AccessControlList{}
	this.Spec = spec
	return &this
}
...
func (o *DefinitionsV1alpha1AccessControlList) GetSpec() DefinitionsV1alpha1AccessControlListSpec {
	if o == nil {
		var ret DefinitionsV1alpha1AccessControlListSpec
		return ret
	}
...
func (o DefinitionsV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
...
func (o DefinitionsV1alpha1AccessControlList) ToMap() (map[string]interface{}, error) {
...
func (o *DefinitionsV1alpha1AccessControlList) UnmarshalJSON(data []byte) (err error) {
	...
	varDefinitionsV1alpha1AccessControlList := _DefinitionsV1alpha1AccessControlList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDefinitionsV1alpha1AccessControlList)

	if err != nil {
		return err
	}

	*o = DefinitionsV1alpha1AccessControlList(varDefinitionsV1alpha1AccessControlList)

	return err
}

type NullableDefinitionsV1alpha1AccessControlList struct {
	value *DefinitionsV1alpha1AccessControlList
	isSet bool
}

func (v NullableDefinitionsV1alpha1AccessControlList) Get() *DefinitionsV1alpha1AccessControlList {
	return v.value
}

func (v *NullableDefinitionsV1alpha1AccessControlList) Set(val *DefinitionsV1alpha1AccessControlList) {
	v.value = val
	v.isSet = true
}

func (v NullableDefinitionsV1alpha1AccessControlList) IsSet() bool {
	return v.isSet
}

func (v *NullableDefinitionsV1alpha1AccessControlList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefinitionsV1alpha1AccessControlList(val *DefinitionsV1alpha1AccessControlList) *NullableDefinitionsV1alpha1AccessControlList {
	return &NullableDefinitionsV1alpha1AccessControlList{value: val, isSet: true}
}

func (v NullableDefinitionsV1alpha1AccessControlList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefinitionsV1alpha1AccessControlList) UnmarshalJSON(src []byte) error {
	v.isSet = true
