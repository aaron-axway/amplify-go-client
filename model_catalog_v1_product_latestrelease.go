...
// checks if the CatalogV1ProductLatestrelease type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogV1ProductLatestrelease{}

// CatalogV1ProductLatestrelease Provides newest non-archived release and version. Will be unassigned if no releases exist.
type CatalogV1ProductLatestrelease struct {
...
func NewCatalogV1ProductLatestrelease() *CatalogV1ProductLatestrelease {
	this := CatalogV1ProductLatestrelease{}
	return &this
}
...
func (o CatalogV1ProductLatestrelease) MarshalJSON() ([]byte, error) {
...
func (o CatalogV1ProductLatestrelease) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogV1ProductLatestrelease struct {
	value *CatalogV1ProductLatestrelease
	isSet bool
}

func (v NullableCatalogV1ProductLatestrelease) Get() *CatalogV1ProductLatestrelease {
	return v.value
}

func (v *NullableCatalogV1ProductLatestrelease) Set(val *CatalogV1ProductLatestrelease) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogV1ProductLatestrelease) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogV1ProductLatestrelease) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogV1ProductLatestrelease(val *CatalogV1ProductLatestrelease) *NullableCatalogV1ProductLatestrelease {
	return &NullableCatalogV1ProductLatestrelease{value: val, isSet: true}
}

func (v NullableCatalogV1ProductLatestrelease) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogV1ProductLatestrelease) UnmarshalJSON(src []byte) error {
	v.isSet = true
